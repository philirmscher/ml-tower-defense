...
namespace UnityPython
{
    ...
    {
        private const string PythonFolder = "python-3.9.10-embed-amd64";
        private const string PythonDll = "python39.dll";
        private const string PythonZip = "python39.zip";
        private const string PythonProject = "myproject";

        [RuntimeInitializeOnLoadMethod(RuntimeInitializeLoadType.BeforeSceneLoad)]
        private static void PythonInitialize()
        {
            Debug.Log("Initialize python");
