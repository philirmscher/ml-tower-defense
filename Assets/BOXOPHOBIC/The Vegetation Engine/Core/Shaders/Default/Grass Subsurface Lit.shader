	...
	SubShader
	{
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				half3 Mesh_PivotsOS2291_g70845 = Mesh_PivotsData2831_g70845;
				...
				half Motion_FacingMask5214_g70845 = 1.0;
				...
				float3 Vertex_Motion_Object833_g70845 = ( ( VertexPosRotationAxis50_g70920 + ( VertexPosOtherAxis82_g70920 * cos( Angle44_g70920 ) ) + ( cross( float3(0,0,1) , VertexPosOtherAxis82_g70920 ) * sin( Angle44_g70920 ) ) ) + Motion_30_Details263_g70845 );
				...
				float3 Vertex_Motion_World1118_g70845 = ( ( temp_output_3474_0_g70845 + appendResult2043_g70845 ) + Motion_30_Details263_g70845 );
				#ifdef TVE_FEATURE_BATCHING
				...
				float temp_output_7_0_g70910 = _SizeFadeEndValue;
				float temp_output_335_0_g70845 = saturate( ( ( ( distance( _WorldSpaceCameraPos , ObjectPosition4223_g70845 ) * ( 1.0 / TVE_DistanceFadeBias ) ) - temp_output_7_0_g70910 ) / ( _SizeFadeStartValue - temp_output_7_0_g70910 ) ) );
				float3 appendResult3482_g70845 = (float3(temp_output_335_0_g70845 , temp_output_335_0_g70845 , temp_output_335_0_g70845));
				float3 lerpResult5065_g70845 = lerp( _Vector5 , appendResult3482_g70845 , _SizeFadeMode);
				half3 ObjectData20_g70897 = lerpResult5065_g70845;
				half3 WorldData19_g70897 = _Vector5;
				#ifdef TVE_FEATURE_BATCHING
				float3 staticSwitch14_g70897 = WorldData19_g70897;
				#else
				float3 staticSwitch14_g70897 = ObjectData20_g70897;
				#endif
				float3 Vertex_SizeFade1740_g70845 = staticSwitch14_g70897;
				float3 ase_worldViewDir = ( _WorldSpaceCameraPos.xyz - ase_worldPos );
				ase_worldViewDir = normalize(ase_worldViewDir);
				float3 normalizeResult2696_g70845 = normalize( ase_worldViewDir );
				float3 break2709_g70845 = cross( normalizeResult2696_g70845 , half3(0,1,0) );
				float3 appendResult2710_g70845 = (float3(-break2709_g70845.z , 0.0 , break2709_g70845.x));
				float3 appendResult2667_g70845 = (float3(Global_MeshVariation5104_g70845 , 0.5 , Global_MeshVariation5104_g70845));
				...
				float dotResult2212_g70845 = dot( ViewDir_Normalized3963_g70845 , float3(0,1,0) );
				half Mask_HView2656_g70845 = dotResult2212_g70845;
				float saferPower2652_g70845 = abs( Mask_HView2656_g70845 );
				half3 Grass_Perspective2661_g70845 = ( ( ( mul( GetWorldToObjectMatrix(), float4( appendResult2710_g70845 , 0.0 ) ).xyz * _PerspectivePushValue ) + ( (appendResult2667_g70845*2.0 + -1.0) * _PerspectiveNoiseValue ) ) * Mesh_Height1524_g70845 * pow( saferPower2652_g70845 , _PerspectiveAngleValue ) );
				...
				half Global_MotionHighlight4860_g70845 = ( (( sin( ( break500_g70891.x + break500_g70891.y ) ) * sin( ( break494_g70891.x + break494_g70891.y ) ) )*0.4 + 0.6) * (( sin( ( break500_g70891.x + break500_g70891.y ) ) * sin( ( break494_g70891.x + break494_g70891.y ) ) )*0.4 + 0.6) );
				half Highlight_Tint3231_g70845 = ( Global_MotionHighlight4860_g70845 * Global_MotionPower2223_g70845 * Motion_FadeOut4005_g70845 * Mesh_Height1524_g70845 );
				float vertexToFrag11_g70901 = Highlight_Tint3231_g70845;
				outputPackedVaryingsMeshToPS.ase_texcoord5.y = vertexToFrag11_g70901;
				outputPackedVaryingsMeshToPS.ase_texcoord7.xyz = vertexToFrag3890_g70845;
				outputPackedVaryingsMeshToPS.ase_texcoord8.xyz = vertexToFrag4224_g70845;
				...
				outputPackedVaryingsMeshToPS.ase_texcoord5.z = vertexToFrag11_g70889;
						...
						)
			{
				...
				float vertexToFrag11_g70901 = packedInput.ase_texcoord5.y;
				...
				half3 Blend_AlbedoTinted2808_g70845 = ( ( lerpResult2779_g70845 * float3(1,1,1) * ( ( (_MotionHighlightColor).rgb * vertexToFrag11_g70901 ) + float3( 1,1,1 ) ) ) * Blend_Albedo265_g70845 );
				...
				float3 vertexToFrag3890_g70845 = packedInput.ase_texcoord7.xyz;
				float3 WorldPosition3905_g70845 = vertexToFrag3890_g70845;
				float3 vertexToFrag4224_g70845 = packedInput.ase_texcoord8.xyz;
				half3 ObjectData20_g70886 = vertexToFrag4224_g70845;
				half3 WorldData19_g70886 = vertexToFrag3890_g70845;
				#ifdef TVE_FEATURE_BATCHING
				float3 staticSwitch14_g70886 = WorldData19_g70886;
				...
				half Mesh_Height1524_g70845 = packedInput.ase_color.a;
				float temp_output_7_0_g70892 = _ColorsMaskMinValue;
				half Global_Colors_Mask3692_g70845 = saturate( ( ( Mesh_Height1524_g70845 - temp_output_7_0_g70892 ) / ( _ColorsMaskMaxValue - temp_output_7_0_g70892 ) ) );
				...
				half Subsurface_Mask1557_g70845 = saturate( ( ( Mesh_Height1524_g70845 - temp_output_7_0_g70890 ) / ( _SubsurfaceMaskMaxValue - temp_output_7_0_g70890 ) ) );
				...
				half Main_Albedo_G3526_g70845 = tex2DNode29_g70845.g;
				...
				half Overlay_Mask_2D5121_g70845 = ( ( ( Mesh_Height1524_g70845 * 0.5 ) + Main_Albedo_G3526_g70845 ) * Overlay_Commons1365_g70845 );
				float temp_output_7_0_g70887 = _OverlayMaskMinValue;
				half Overlay_Mask269_g70845 = saturate( ( ( Overlay_Mask_2D5121_g70845 - temp_output_7_0_g70887 ) / ( _OverlayMaskMaxValue - temp_output_7_0_g70887 ) ) );
				...
				float vertexToFrag11_g70889 = packedInput.ase_texcoord5.z;
				...
				half Final_AlphaFade3727_g70845 = 1.0;
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh  )
			{
				...
				half Highlight_Tint3231_g70845 = ( Global_MotionHighlight4860_g70845 * Global_MotionPower2223_g70845 * Motion_FadeOut4005_g70845 * Mesh_Height1524_g70845 );
				float vertexToFrag11_g70901 = Highlight_Tint3231_g70845;
				outputPackedVaryingsMeshToPS.ase_texcoord2.y = vertexToFrag11_g70901;
				outputPackedVaryingsMeshToPS.ase_texcoord4.xyz = vertexToFrag3890_g70845;
				outputPackedVaryingsMeshToPS.ase_texcoord5.xyz = vertexToFrag4224_g70845;
				outputPackedVaryingsMeshToPS.ase_texcoord6.xyz = ase_worldPos;
				float Mesh_Occlusion318_g70845 = inputMesh.ase_color.g;
				float temp_output_7_0_g70885 = _VertexOcclusionMinValue;
				float temp_output_3377_0_g70845 = saturate( ( ( Mesh_Occlusion318_g70845 - temp_output_7_0_g70885 ) / ( _VertexOcclusionMaxValue - temp_output_7_0_g70885 ) ) );
				float vertexToFrag11_g70889 = temp_output_3377_0_g70845;
				outputPackedVaryingsMeshToPS.ase_texcoord2.z = vertexToFrag11_g70889;
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float3 lerpResult2779_g70845 = lerp( (_GradientColorTwo).rgb , (_GradientColorOne).rgb , vertexToFrag11_g70849);
				float vertexToFrag11_g70901 = packedInput.ase_texcoord2.y;
				...
				float3 temp_cast_0 = (dotResult3616_g70845).xxx;
				float4 temp_output_91_19_g70893 = TVE_ColorsCoords;
				float3 vertexToFrag3890_g70845 = packedInput.ase_texcoord4.xyz;
				float3 WorldPosition3905_g70845 = vertexToFrag3890_g70845;
				...
				half3 Final_Albedo359_g70845 = lerpResult336_g70845;
				float3 temp_cast_6 = (1.0).xxx;
				float vertexToFrag11_g70889 = packedInput.ase_texcoord2.z;
				float3 lerpResult2945_g70845 = lerp( (_VertexOcclusionColor).rgb , temp_cast_6 , vertexToFrag11_g70889);
				float3 Vertex_Occlusion648_g70845 = lerpResult2945_g70845;
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				outputPackedVaryingsMeshToPS.ase_texcoord2.xyz = vertexToFrag3890_g70845;
					...
					)
			{
				...
				float localCustomAlphaClip9_g70878 = ( 0.0 );
				half Final_AlphaFade3727_g70845 = 1.0;
				half2 Main_UVs15_g70845 = ( ( packedInput.ase_texcoord1.xy * (_MainUVs).xy ) + (_MainUVs).zw );
				float4 tex2DNode29_g70845 = tex2D( _MainAlbedoTex, Main_UVs15_g70845 );
				float Main_Alpha316_g70845 = ( _MainColor.a * tex2DNode29_g70845.a );
				float4 temp_output_93_19_g70850 = TVE_ExtrasCoords;
				float3 vertexToFrag3890_g70845 = packedInput.ase_texcoord2.xyz;
				float3 WorldPosition3905_g70845 = vertexToFrag3890_g70845;
		...
		Pass
		{
			...
			AttributesMesh ApplyMeshModification(AttributesMesh inputMesh, float3 timeParameters, inout PackedVaryingsMeshToPS outputPackedVaryingsMeshToPS )
			{
				...
				half Highlight_Tint3231_g70845 = ( Global_MotionHighlight4860_g70845 * Global_MotionPower2223_g70845 * Motion_FadeOut4005_g70845 * Mesh_Height1524_g70845 );
				float vertexToFrag11_g70901 = Highlight_Tint3231_g70845;
				outputPackedVaryingsMeshToPS.ase_texcoord7.y = vertexToFrag11_g70901;
				outputPackedVaryingsMeshToPS.ase_texcoord9.xyz = vertexToFrag3890_g70845;
				outputPackedVaryingsMeshToPS.ase_texcoord10.xyz = vertexToFrag4224_g70845;
				float Mesh_Occlusion318_g70845 = inputMesh.ase_color.g;
				float temp_output_7_0_g70885 = _VertexOcclusionMinValue;
				float temp_output_3377_0_g70845 = saturate( ( ( Mesh_Occlusion318_g70845 - temp_output_7_0_g70885 ) / ( _VertexOcclusionMaxValue - temp_output_7_0_g70885 ) ) );
				float vertexToFrag11_g70889 = temp_output_3377_0_g70845;
				outputPackedVaryingsMeshToPS.ase_texcoord7.z = vertexToFrag11_g70889;
						...
						)
			{
				...
				float3 lerpResult2779_g70845 = lerp( (_GradientColorTwo).rgb , (_GradientColorOne).rgb , vertexToFrag11_g70849);
				float vertexToFrag11_g70901 = packedInput.ase_texcoord7.y;
				...
				float3 temp_cast_0 = (dotResult3616_g70845).xxx;
				float4 temp_output_91_19_g70893 = TVE_ColorsCoords;
				float3 vertexToFrag3890_g70845 = packedInput.ase_texcoord9.xyz;
				float3 WorldPosition3905_g70845 = vertexToFrag3890_g70845;
				float3 vertexToFrag4224_g70845 = packedInput.ase_texcoord10.xyz;
				half3 ObjectData20_g70886 = vertexToFrag4224_g70845;
				half3 WorldData19_g70886 = vertexToFrag3890_g70845;
				#ifdef TVE_FEATURE_BATCHING
				float3 staticSwitch14_g70886 = WorldData19_g70886;
				...
				half3 Final_Albedo359_g70845 = lerpResult336_g70845;
				float3 temp_cast_6 = (1.0).xxx;
				float vertexToFrag11_g70889 = packedInput.ase_texcoord7.z;
				float3 lerpResult2945_g70845 = lerp( (_VertexOcclusionColor).rgb , temp_cast_6 , vertexToFrag11_g70889);
				float3 Vertex_Occlusion648_g70845 = lerpResult2945_g70845;
        ...
        Pass
        {
			...
			VertexOutput VertexFunction(VertexInput inputMesh  )
			{
				...
				o.ase_texcoord4.xyz = vertexToFrag4224_g70845;
...
/*ASEBEGIN
Version=18934
1920;6;1920;1023;3052.488;547.552;1;True;False
Node;AmplifyShaderEditor.RangedFloatNode;1013;-1408,-768;Half;False;Property;_subsurface_shadow;_subsurface_shadow;193;1;[HideInInspector];Create;True;0;0;0;True;0;False;1;0;1;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;1010;-1984,-896;Half;False;Property;_IsSubsurfaceShader;_IsSubsurfaceShader;194;1;[HideInInspector];Create;True;0;0;0;True;0;False;1;0;1;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;713;-2176,384;Inherit;False;Define Shader Grass;-1;;70843;921559c53826c0142ba6e27dd03eaef2;0;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=4FE8BF5753F49939E538B2415E35F8FC3A559EFC
