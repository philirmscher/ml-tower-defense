	...
	SubShader
	{
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				float3 Final_VertexPosition890_g70929 = ( VertexPosition3588_g70929 + _DisableSRPBatcher );
				...
				half Detail_Type5060_g70929 = _DetailTypeMode;
				float2 lerpResult5059_g70929 = lerp( lerpResult1545_g70929 , (ase_worldPos).xz , Detail_Type5060_g70929);
				float2 vertexToFrag11_g71000 = ( ( lerpResult5059_g70929 * (_SecondUVs).xy ) + (_SecondUVs).zw );
				...
				float lerpResult1537_g70929 = lerp( World_Normal4101_g70929.y , -World_Normal4101_g70929.y , _DetailProjectionMode);
				float lerpResult5062_g70929 = lerp( temp_output_990_0_g70929 , ( lerpResult1537_g70929 * 0.5 ) , Detail_Type5060_g70929);
				float vertexToFrag11_g70931 = ( lerpResult5062_g70929 + _DetailMeshValue );
				...
				outputPackedVaryingsMeshToPS.ase_texcoord6.w = vertexToFrag11_g70951;
						...
						)
			{
				...
				half Main_Metallic237_g70929 = ( tex2DNode35_g70929.r * _MainMetallicValue );
				half Second_Metallic226_g70929 = ( tex2DNode33_g70929.r * _SecondMetallicValue );
				float lerpResult278_g70929 = lerp( Main_Metallic237_g70929 , Second_Metallic226_g70929 , Mask_Detail147_g70929);
				#ifdef TVE_FEATURE_DETAIL
				float staticSwitch299_g70929 = lerpResult278_g70929;
				#else
				float staticSwitch299_g70929 = Main_Metallic237_g70929;
				#endif
				half Blend_Metallic306_g70929 = staticSwitch299_g70929;
				float lerpResult342_g70929 = lerp( Blend_Metallic306_g70929 , 0.0 , Overlay_Mask269_g70929);
				half Final_Metallic367_g70929 = lerpResult342_g70929;
				...
				float vertexToFrag11_g70951 = packedInput.ase_texcoord6.w;
				...
				surfaceDescription.Albedo = Final_Albedo359_g70929;
				surfaceDescription.Normal = Final_Normal366_g70929;
				surfaceDescription.BentNormal = float3( 0, 0, 1 );
				surfaceDescription.CoatMask = 0;
				surfaceDescription.Metallic = Final_Metallic367_g70929;
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh  )
			{
				...
				float lerpResult4755_g70929 = lerp( 1.0 , saturate( ( ( distance( ase_worldPos , _WorldSpaceCameraPos ) - temp_output_7_0_g70945 ) / ( TVE_CameraFadeEnd - temp_output_7_0_g70945 ) ) ) , _FadeCameraValue);
				float vertexToFrag11_g70951 = lerpResult4755_g70929;
				outputPackedVaryingsMeshToPS.ase_texcoord3.w = vertexToFrag11_g70951;
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float localCustomAlphaClip9_g70962 = ( 0.0 );
				float vertexToFrag11_g70951 = packedInput.ase_texcoord3.w;
				half Fade_Camera_Mask5149_g70929 = 1.0;
				float lerpResult5141_g70929 = lerp( 1.0 , vertexToFrag11_g70951 , Fade_Camera_Mask5149_g70929);
				half Fade_Camera3743_g70929 = lerpResult5141_g70929;
				float temp_output_41_0_g70948 = ( 1.0 * Fade_Camera3743_g70929 );
		...
		Pass
		{
			...
			AttributesMesh ApplyMeshModification(AttributesMesh inputMesh, float3 timeParameters, inout PackedVaryingsMeshToPS outputPackedVaryingsMeshToPS )
			{
				...
				float lerpResult4755_g70929 = lerp( 1.0 , saturate( ( ( distance( ase_worldPos , _WorldSpaceCameraPos ) - temp_output_7_0_g70945 ) / ( TVE_CameraFadeEnd - temp_output_7_0_g70945 ) ) ) , _FadeCameraValue);
				float vertexToFrag11_g70951 = lerpResult4755_g70929;
				outputPackedVaryingsMeshToPS.ase_texcoord8.w = vertexToFrag11_g70951;
						...
						)
			{
				...
				float localCustomAlphaClip9_g70962 = ( 0.0 );
				float vertexToFrag11_g70951 = packedInput.ase_texcoord8.w;
				half Fade_Camera_Mask5149_g70929 = 1.0;
				float lerpResult5141_g70929 = lerp( 1.0 , vertexToFrag11_g70951 , Fade_Camera_Mask5149_g70929);
				half Fade_Camera3743_g70929 = lerpResult5141_g70929;
				float temp_output_41_0_g70948 = ( 1.0 * Fade_Camera3743_g70929 );
...
/*ASEBEGIN
Version=18934
1920;6;1920;1023;3175.445;618.538;1;True;False
...
Node;AmplifyShaderEditor.FunctionNode;407;-1536,-896;Inherit;False;Compile Core;-1;;71008;634b02fd1f32e6a4c875d8fc2c450956;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;382;-2176,-384;Inherit;False;Base Shader;0;;70929;856f7164d1c579d43a5cf4968a75ca43;79,3880,1,4028,1,4029,1,3903,1,3900,1,4204,1,3904,1,3908,1,4172,1,1300,1,1298,1,4179,1,4995,1,3586,0,4499,0,1708,0,3658,0,3509,1,5151,1,3873,1,893,0,5196,0,5128,1,5156,1,1717,1,1715,1,1714,1,1718,1,5075,1,916,1,1763,0,1762,0,3568,1,5118,1,1776,0,3475,1,4210,1,1745,0,3479,0,3501,0,5152,1,1646,0,1271,0,3889,1,2807,0,3886,0,4999,0,3887,0,3957,1,2172,0,3883,0,3728,1,3949,0,5147,0,5146,1,2658,0,1742,0,3484,0,1736,1,4837,1,1735,1,1733,1,5079,1,1737,1,1734,1,878,1,1550,1,860,0,2261,1,2260,1,2054,1,2032,1,2039,1,2062,1,3243,0,5220,0,4217,1,5090,1,4242,0;5;5115;FLOAT;1;False;5127;FLOAT;1;False;5143;FLOAT;1;False;5119;FLOAT;1;False;5117;FLOAT;1;False;21;FLOAT3;0;FLOAT3;528;FLOAT3;2489;FLOAT;531;FLOAT;4842;FLOAT;529;FLOAT;3678;FLOAT;530;FLOAT;4122;FLOAT;4134;FLOAT;1235;FLOAT3;1230;FLOAT;1461;FLOAT;1290;FLOAT;721;FLOAT;532;FLOAT;629;FLOAT3;534;FLOAT;4867;FLOAT4;5246;FLOAT4;4841
...
Node;AmplifyShaderEditor.RangedFloatNode;127;-2176,-896;Half;False;Property;_IsPropShader;_IsPropShader;192;1;[HideInInspector];Create;True;0;0;0;True;0;False;1;0;1;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;343;-2176,384;Inherit;False;Define Shader Object;-1;;70928;1237b3cc9fbfe714d8343c91216dc9b4;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;134;-1984,-896;Half;False;Property;_IsStandardShader;_IsStandardShader;193;1;[HideInInspector];Create;True;0;0;0;True;0;False;1;0;1;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;405;-1920,384;Inherit;False;Define Pipeline HD;-1;;70926;7af1bc24c286d754db63fb6a44aba77b;0;0;1;FLOAT;529
...
Node;AmplifyShaderEditor.FunctionNode;406;-1344,-896;Inherit;False;Compile All Shaders;-1;;70927;e67c8238031dbf04ab79a5d4d63d1b4f;0;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=E794ED579A4D29C0640DD10A8F1A4AE56CAB1030
