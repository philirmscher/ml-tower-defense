	...
	LOD 0
		...
		Pass
		{
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				half4 break469_g20390 = saturate( ( ( tex2DNode17_g20390 - temp_cast_0 ) / ( _MainTexMaxValue - temp_output_7_0_g20782 ) ) );
				...
				half2 temp_output_851_0_g20390 = saturate( ( ( abs( (( (temp_output_35_0_g20804).zw + ( (temp_output_35_0_g20804).xy * (WorldPosition).xz ) )*2.002 + -1.001) ) - temp_cast_1 ) / ( 1.0 - temp_output_7_0_g20780 ) ) );
...
/*ASEBEGIN
Version=18935
1920;12;1920;1017;1228.101;2064.039;1;True;False
Node;AmplifyShaderEditor.FunctionNode;131;-256,-1536;Inherit;False;Define Element Motion;62;;19304;6eebc31017d99e84e811285e6a5d199d;0;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=B87192BBA8999B72819CFFAB86E02C633E8DC724