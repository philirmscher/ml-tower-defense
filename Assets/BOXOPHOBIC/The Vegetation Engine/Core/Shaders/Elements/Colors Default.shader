	...
	LOD 0
		...
		Pass
		{
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				half4 break469_g20766 = saturate( ( ( tex2DNode17_g20766 - temp_cast_0 ) / ( _MainTexMaxValue - temp_output_7_0_g20782 ) ) );
				...
				half2 temp_output_851_0_g20766 = saturate( ( ( abs( (( (temp_output_35_0_g20804).zw + ( (temp_output_35_0_g20804).xy * (WorldPosition).xz ) )*2.002 + -1.001) ) - temp_cast_1 ) / ( 1.0 - temp_output_7_0_g20780 ) ) );
...
/*ASEBEGIN
Version=18935
1920;12;1920;1017;1478.644;1039.456;1;True;False
...
ASEEND*/
//CHKSM=EF7447D5911E537F61549CF80DC9855604A71F1F