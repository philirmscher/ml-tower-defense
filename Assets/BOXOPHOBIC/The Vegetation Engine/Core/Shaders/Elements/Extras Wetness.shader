	...
	LOD 0
		...
		Pass
		{
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				half temp_output_9_0_g20792 = Base_Extras_RGB213_g18710;
				half sRGB8_g20792 = temp_output_9_0_g20792;
				half localGammaToLinearFloatFast8_g20792 = GammaToLinearFloatFast( sRGB8_g20792 );
				#ifdef UNITY_COLORSPACE_GAMMA
				float staticSwitch1_g20792 = temp_output_9_0_g20792;
				#else
				float staticSwitch1_g20792 = localGammaToLinearFloatFast8_g20792;
				#endif
				half3 appendResult209_g18710 = (half3(0.0 , staticSwitch1_g20792 , 0.0));
				...
				half4 break469_g18710 = saturate( ( ( tex2DNode17_g18710 - temp_cast_0 ) / ( _MainTexMaxValue - temp_output_7_0_g20782 ) ) );
				...
				half2 temp_output_851_0_g18710 = saturate( ( ( abs( (( (temp_output_35_0_g20804).zw + ( (temp_output_35_0_g20804).xy * (WorldPosition).xz ) )*2.002 + -1.001) ) - temp_cast_1 ) / ( 1.0 - temp_output_7_0_g20780 ) ) );
...
/*ASEBEGIN
Version=18935
1920;12;1920;1017;767.6006;1964.039;1;True;False
...
Node;AmplifyShaderEditor.FunctionNode;124;-256,-1536;Inherit;False;Define Element Extras;62;;20805;adca672cb6779794dba5f669b4c5f8e3;0;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=DCBA8A06B2BF2838261EF1616E4AF9F034073C11