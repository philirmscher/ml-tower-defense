	...
	LOD 0
		...
		Pass
		{
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				float4 temp_cast_0 = (temp_output_7_0_g20782).xxxx;
				float4 break469_g20496 = saturate( ( ( tex2DNode17_g20496 - temp_cast_0 ) / ( _MainTexMaxValue - temp_output_7_0_g20782 ) ) );
				...
				float temp_output_7_0_g20801 = Noise_Min893_g20496;
				float4 temp_cast_3 = (temp_output_7_0_g20801).xxxx;
				half Noise_Max894_g20496 = _NoiseMaxValue;
				float4 break997_g20496 = saturate( ( ( tex2D( _NoiseTex, ( ( appendResult959_g20496 * Noise_Scale892_g20496 ) + mulTime962_g20496 ) ) - temp_cast_3 ) / ( Noise_Max894_g20496 - temp_output_7_0_g20801 ) ) );
				...
				float2 temp_cast_4 = (temp_output_7_0_g20780).xx;
				float2 temp_output_851_0_g20496 = saturate( ( ( abs( (( (temp_output_35_0_g20804).zw + ( (temp_output_35_0_g20804).xy * (WorldPosition).xz ) )*2.002 + -1.001) ) - temp_cast_4 ) / ( 1.0 - temp_output_7_0_g20780 ) ) );
...
/*ASEBEGIN
Version=18935
1920;12;1920;1017;1364.803;1457.791;1;True;False
Node;AmplifyShaderEditor.FunctionNode;177;-640,-1280;Inherit;False;Define Element Motion;62;;19669;6eebc31017d99e84e811285e6a5d199d;0;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=87704834401D1A4A159B23D8910193854C1A7454