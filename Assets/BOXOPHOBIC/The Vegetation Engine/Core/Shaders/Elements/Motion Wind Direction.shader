	...
	LOD 0
		...
		Pass
		{
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				float temp_output_7_0_g53341 = _MainTexMinValue;
				float4 temp_cast_2 = (temp_output_7_0_g53341).xxxx;
				float4 break469_g53336 = saturate( ( ( tex2DNode17_g53336 - temp_cast_2 ) / ( _MainTexMaxValue - temp_output_7_0_g53341 ) ) );
				half MainTex_A74_g53336 = break469_g53336.a;
				half4 Colors37_g53338 = TVE_ColorsCoords;
				half4 Extras37_g53338 = TVE_ExtrasCoords;
				half4 Motion37_g53338 = TVE_MotionCoords;
				half4 Vertex37_g53338 = TVE_VertexCoords;
				half4 localIS_ELEMENT37_g53338 = IS_ELEMENT( Colors37_g53338 , Extras37_g53338 , Motion37_g53338 , Vertex37_g53338 );
				float4 temp_output_35_0_g53360 = localIS_ELEMENT37_g53338;
				float temp_output_7_0_g53339 = TVE_ElementsFadeValue;
				float2 temp_cast_3 = (temp_output_7_0_g53339).xx;
				float2 temp_output_851_0_g53336 = saturate( ( ( abs( (( (temp_output_35_0_g53360).zw + ( (temp_output_35_0_g53360).xy * (WorldPosition).xz ) )*2.002 + -1.001) ) - temp_cast_3 ) / ( 1.0 - temp_output_7_0_g53339 ) ) );
...
/*ASEBEGIN
Version=18935
1920;12;1920;1017;1604.608;1518.464;1;True;False
...
ASEEND*/
//CHKSM=84A67B2351D4EDD7FC6BB95E390E9B0992795EC1