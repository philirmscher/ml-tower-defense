	...
	LOD 0
		...
		Pass
		{
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				half4 break469_g20718 = saturate( ( ( tex2DNode17_g20718 - temp_cast_0 ) / ( _MainTexMaxValue - temp_output_7_0_g20782 ) ) );
				...
				half2 temp_output_851_0_g20718 = saturate( ( ( abs( (( (temp_output_35_0_g20804).zw + ( (temp_output_35_0_g20804).xy * (WorldPosition).xz ) )*2.002 + -1.001) ) - temp_cast_1 ) / ( 1.0 - temp_output_7_0_g20780 ) ) );
				...
				half temp_output_9_0_g20789 = lerpResult933_g20718;
				half sRGB8_g20789 = temp_output_9_0_g20789;
				half localGammaToLinearFloatFast8_g20789 = GammaToLinearFloatFast( sRGB8_g20789 );
				#ifdef UNITY_COLORSPACE_GAMMA
				float staticSwitch1_g20789 = temp_output_9_0_g20789;
				#else
				float staticSwitch1_g20789 = localGammaToLinearFloatFast8_g20789;
				#endif
				half Final_Alpha_A211_g20718 = staticSwitch1_g20789;
...
/*ASEBEGIN
Version=18935
1920;12;1920;1017;1518.483;1739.122;1;True;False
...
Node;AmplifyShaderEditor.FunctionNode;106;-640,-1408;Inherit;False;Define Element Extras;64;;20805;adca672cb6779794dba5f669b4c5f8e3;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;112;-640,-1280;Inherit;False;Property;_render_src;_render_src;62;1;[HideInInspector];Create;True;0;0;0;True;0;False;2;2;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;113;-480,-1280;Inherit;False;Property;_render_dst;_render_dst;63;1;[HideInInspector];Create;True;0;0;0;True;0;False;0;0;0;0;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=6BB40F238D87DF17C8D38EA10AD2E5F593CCC85B