	...
	LOD 0
		...
		Pass
		{
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				half temp_output_7_0_g21082 = Noise_Min893_g21066;
				half Noise_Max894_g21066 = _NoiseMaxValue;
				half4 lerpResult772_g21066 = lerp( _NoiseColorOne , _NoiseColorTwo , saturate( ( ( simpleNoise775_g21066 - temp_output_7_0_g21082 ) / ( Noise_Max894_g21066 - temp_output_7_0_g21082 ) ) ));
				half3 Final_Noise_RGB784_g21066 = (lerpResult772_g21066).rgb;
				half4 Colors37_g21068 = TVE_ColorsCoords;
				half4 Extras37_g21068 = TVE_ExtrasCoords;
				half4 Motion37_g21068 = TVE_MotionCoords;
				half4 Vertex37_g21068 = TVE_VertexCoords;
				half4 localIS_ELEMENT37_g21068 = IS_ELEMENT( Colors37_g21068 , Extras37_g21068 , Motion37_g21068 , Vertex37_g21068 );
				half4 temp_output_35_0_g21090 = localIS_ELEMENT37_g21068;
				half temp_output_7_0_g21069 = TVE_ElementsFadeValue;
				half2 temp_cast_0 = (temp_output_7_0_g21069).xx;
				half2 temp_output_851_0_g21066 = saturate( ( ( abs( (( (temp_output_35_0_g21090).zw + ( (temp_output_35_0_g21090).xy * (WorldPosition).xz ) )*2.002 + -1.001) ) - temp_cast_0 ) / ( 1.0 - temp_output_7_0_g21069 ) ) );
				...
				half temp_output_7_0_g21071 = _MainTexMinValue;
				half4 temp_cast_1 = (temp_output_7_0_g21071).xxxx;
				half4 break469_g21066 = saturate( ( ( tex2DNode17_g21066 - temp_cast_1 ) / ( _MainTexMaxValue - temp_output_7_0_g21071 ) ) );
...
/*ASEBEGIN
Version=18935
1920;12;1920;1017;1397.909;1299.683;1;True;False
...
ASEEND*/
//CHKSM=BB2677C0638C35AA69F2EF558F53AD9045B0DFB7