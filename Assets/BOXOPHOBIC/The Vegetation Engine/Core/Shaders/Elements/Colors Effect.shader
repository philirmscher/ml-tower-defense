	...
	LOD 0
		...
		Pass
		{
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				half temp_output_7_0_g20818 = _MainTexMinValue;
				half4 temp_cast_0 = (temp_output_7_0_g20818).xxxx;
				half4 break469_g20813 = saturate( ( ( tex2DNode17_g20813 - temp_cast_0 ) / ( _MainTexMaxValue - temp_output_7_0_g20818 ) ) );
				half MainTex_A74_g20813 = break469_g20813.a;
				half lerpResult1247_g20813 = lerp( 1.0 , Base_Extras_A423_g20813 , MainTex_A74_g20813);
				half4 Colors37_g20815 = TVE_ColorsCoords;
				half4 Extras37_g20815 = TVE_ExtrasCoords;
				half4 Motion37_g20815 = TVE_MotionCoords;
				half4 Vertex37_g20815 = TVE_VertexCoords;
				half4 localIS_ELEMENT37_g20815 = IS_ELEMENT( Colors37_g20815 , Extras37_g20815 , Motion37_g20815 , Vertex37_g20815 );
				half4 temp_output_35_0_g20837 = localIS_ELEMENT37_g20815;
				half temp_output_7_0_g20816 = TVE_ElementsFadeValue;
				half2 temp_cast_1 = (temp_output_7_0_g20816).xx;
				half2 temp_output_851_0_g20813 = saturate( ( ( abs( (( (temp_output_35_0_g20837).zw + ( (temp_output_35_0_g20837).xy * (WorldPosition).xz ) )*2.002 + -1.001) ) - temp_cast_1 ) / ( 1.0 - temp_output_7_0_g20816 ) ) );
...
/*ASEBEGIN
Version=18935
1920;12;1920;1017;1707.644;1040.456;1;True;False
Node;AmplifyShaderEditor.RangedFloatNode;205;-640,-640;Inherit;False;Property;_render_src;_render_src;64;1;[HideInInspector];Create;True;0;0;0;True;0;False;2;2;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;206;-480,-640;Inherit;False;Property;_render_dst;_render_dst;65;1;[HideInInspector];Create;True;0;0;0;True;0;False;0;0;0;0;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=19B7828C8A98D5FD79E357296314E08D87A361A8