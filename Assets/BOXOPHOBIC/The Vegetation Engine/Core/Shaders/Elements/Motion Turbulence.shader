...
Shader "BOXOPHOBIC/The Vegetation Engine/Elements/Default/Motion Turbulence"
{
	Properties
	{
	...
	LOD 0
		...
		Pass
		{
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				float temp_output_7_0_g20793 = Noise_Min893_g20507;
				float4 temp_cast_0 = (temp_output_7_0_g20793).xxxx;
				half Noise_Max894_g20507 = _NoiseMaxValue;
				float4 break1133_g20507 = saturate( ( ( tex2D( _NoiseTex, ( ( appendResult1122_g20507 * Noise_Scale892_g20507 ) + appendResult1200_g20507 ) ) - temp_cast_0 ) / ( Noise_Max894_g20507 - temp_output_7_0_g20793 ) ) );
				...
				float temp_output_7_0_g20782 = _MainTexMinValue;
				float4 temp_cast_1 = (temp_output_7_0_g20782).xxxx;
				float4 break469_g20507 = saturate( ( ( tex2DNode17_g20507 - temp_cast_1 ) / ( _MainTexMaxValue - temp_output_7_0_g20782 ) ) );
				...
				float4 temp_output_35_0_g20804 = localIS_ELEMENT37_g20779;
				float temp_output_7_0_g20780 = TVE_ElementsFadeValue;
				float2 temp_cast_2 = (temp_output_7_0_g20780).xx;
				float2 temp_output_851_0_g20507 = saturate( ( ( abs( (( (temp_output_35_0_g20804).zw + ( (temp_output_35_0_g20804).xy * (WorldPosition).xz ) )*2.002 + -1.001) ) - temp_cast_2 ) / ( 1.0 - temp_output_7_0_g20780 ) ) );
				...
				half Element_Intensity56_g20507 = ( _ElementIntensity * i.ase_color.a * Fade_EdgeMask656_g20507 * _RaycastFadeValue );
				half Element_EffectInteraction946_g20507 = _ElementInteractionMode;
				half Final_MotionNoise_A1204_g20507 = ( ( MainTex_A74_g20507 * Element_Intensity56_g20507 ) + ( Element_EffectInteraction946_g20507 * 0.0 ) );
				float4 appendResult1211_g20507 = (float4(Final_MotionNoise_RGB1209_g20507 , Final_MotionNoise_A1204_g20507));
				
				
				finalColor = appendResult1211_g20507;
				return finalColor;
			}
			ENDCG
		}
...
/*ASEBEGIN
Version=18935
1920;12;1920;1017;1666.803;1622.791;1;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;197;-640,-1152;Half;False;Property;_render_colormask;_render_colormask;64;1;[HideInInspector];Create;True;0;0;0;True;0;False;15;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;177;-640,-1280;Inherit;False;Define Element Motion;62;;20805;6eebc31017d99e84e811285e6a5d199d;0;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=B7B8EAAE5274ED6E309E8275F5CE54ABDBA97603