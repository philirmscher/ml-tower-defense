	...
	LOD 0
		...
		Pass
		{
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				float4 break469_g20191 = saturate( ( ( tex2DNode17_g20191 - temp_cast_0 ) / ( _MainTexMaxValue - temp_output_7_0_g20782 ) ) );
				...
				float2 temp_cast_3 = (temp_output_7_0_g20780).xx;
				float2 temp_output_851_0_g20191 = saturate( ( ( abs( (( (temp_output_35_0_g20804).zw + ( (temp_output_35_0_g20804).xy * (WorldPosition).xz ) )*2.002 + -1.001) ) - temp_cast_3 ) / ( 1.0 - temp_output_7_0_g20780 ) ) );
...
/*ASEBEGIN
Version=18935
1920;12;1920;1017;1423.464;1740.379;1;True;False
Node;AmplifyShaderEditor.FunctionNode;117;-640,-1280;Inherit;False;Define Element Motion;62;;19417;6eebc31017d99e84e811285e6a5d199d;0;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=B1589097219E4A45BAA5D0424B2E55EE8FBDA06D