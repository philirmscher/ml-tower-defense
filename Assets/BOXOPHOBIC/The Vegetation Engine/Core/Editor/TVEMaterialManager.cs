...
namespace TheVegetationEngine
{
    public class TVEMaterialManager : EditorWindow
    {
        ...
        {
        "All", "Render Settings", "Global Settings", "Main Settings", "Detail Settings", "Occlusion Settings", "Emissive Settings", "Subsurface Settings", "Gradient Settings", "Noise Settings", "Perspective Settings", "Size Fade Settings", "Motion Settings",
        };
        ...
        {
            new TVEMaterialData("_CategoryGlobal", "Global Settings", false),
            ...
            new TVEMaterialData("_ColorsMaskMinValue", "Color Mask Min", -9999, 0, 1, false, false),
            ...
            new TVEMaterialData("_AlphaMaskMinValue", "Alpha Mask Min", -9999, 0, 1, false, false),
            ...
            new TVEMaterialData("_OverlayMaskMinValue", "Overlay Mask Min", -9999, 0, 1, false, false),
            ...
            new TVEMaterialData("_SpaceGlobalPosition", false),
        ...
        List<TVEMaterialData> secondData = new List<TVEMaterialData>
        {
            ...
            new TVEMaterialData("_DetailMaskMode", "Detail Mask Source", -9999, "Main_Mask 0 Detail_Mask 1", true),
            new TVEMaterialData("_DetailMaskInvertMode", "Detail Mask Invert", -9999, "Off 0 On 1", false),
            new TVEMaterialData("_DetailMeshValue", "Detail Mask Offset", -9999, -1, 1, false, false),
        ...
        List<TVEMaterialData> occlusionData = new List<TVEMaterialData>
        {
            ...
            new TVEMaterialData("_VertexOcclusionColor", "Vertex Occlusion Color", new Color(-9999, 0,0,0), true, false),
        ...
        List<TVEMaterialData> subsurfaceData = new List<TVEMaterialData>
        {
            ...
            new TVEMaterialData("_SubsurfaceScatteringValue", "Subsurface Scattering", -9999, 0, 16, false, true),
            ...
            // Legacy
            new TVEMaterialData("_MainLightScatteringValue", "Subsurface Scattering (Legacy)", -9999, 0, 16, false, true),
            new TVEMaterialData("_MainLightAngleValue", "Subsurface Angle (Legacy)", -9999, 1, 16, false, false),
            new TVEMaterialData("_MainLightNormalValue", "Subsurface Normal (Legacy)", -9999, 0, 1, false, false),
        };
        ...
        List<TVEMaterialData> sizeFadeData = new List<TVEMaterialData>
        {
            ...
            new TVEMaterialData("_SizeFadeMode", "Size Fade Mode", -9999, "Off 0 On 1", false),
        ...
        List<TVEMaterialData> motionData = new List<TVEMaterialData>
        {
            ...
            new TVEMaterialData("_MotionFacingValue", "Motion Facing Direction", -9999, 0, 1, false, false),
            new TVEMaterialData("_MotionNormalValue", "Motion Normal Direction", -9999, 0, 1, false, false),

            new TVEMaterialData("_MotionAmplitude_10", "Bending Amplitude", -9999, 0, 2, false, true),
            new TVEMaterialData("_MotionSpeed_10", "Bending Speed", -9999, 0, 40, true, false),
            ...
            new TVEMaterialData("_MotionAmplitude_20", "Squash Amplitude", -9999, 0, 2, false, true),
            new TVEMaterialData("_MotionSpeed_20", "Squash Speed", -9999, 0, 40, true, false),
            new TVEMaterialData("_MotionScale_20", "Squash Scale", -9999, 0, 20, false, false),
            new TVEMaterialData("_MotionVariation_20", "Squash Variation", -9999, 0, 20, false, false),

            new TVEMaterialData("_MotionAmplitude_32", "Flutter Amplitide", -9999, 0, 2, false, true),
            new TVEMaterialData("_MotionSpeed_32", "Flutter Speed", -9999, 0, 40, true, false),
            ...
            new TVEMaterialData("_MotionValue_20", "Use Squash Motion Settings", -9999, false),
        ...
        Vector4 StyledVector(string name, Vector4 vector, bool space)
        {
            ...
            else
            {
                ...
                if (vector.x == -8888)
                {
                    ...
                    EditorGUI.showMixedValue = true;
                    vector = EditorGUILayout.Vector4Field(new GUIContent(""), vector);
                    EditorGUI.showMixedValue = false;
                }
                else
                {
        ...
        Color StyledColor(string name, Color color, bool HDR, bool space)
        {
            ...
            else
            {
                ...
                if (color.r == -8888)
                {
                    ...
                    EditorGUI.showMixedValue = true;
                    color = EditorGUILayout.ColorField(new GUIContent(""), color, true, true, HDR);
                    EditorGUI.showMixedValue = false;
                }
                else
                {
