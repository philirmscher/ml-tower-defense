...
Shader "BOXOPHOBIC/The Vegetation Engine/Impostors/Vegetation Standard Lit (Octahedron)"
{
    Properties
    {
    ...
    SubShader
    {
		...
		Pass
        {
			...
			PackedVaryingsMeshToPS Vert(AttributesMesh inputMesh )
			{
				...
				float3 viewToObj3965_g69706 = mul( GetWorldToObjectMatrix(), mul( UNITY_MATRIX_I_V , float4( outputPackedVaryingsMeshToPS.viewPos99.xyz, 1 ) ) ).xyz;
				float3 VertexPosition3564_g69706 = viewToObj3965_g69706;
				half3 VertexPos40_g69751 = VertexPosition3564_g69706;
				float3 appendResult74_g69751 = (float3(VertexPos40_g69751.x , 0.0 , 0.0));
				half3 VertexPosRotationAxis50_g69751 = appendResult74_g69751;
				float3 break84_g69751 = VertexPos40_g69751;
				float3 appendResult81_g69751 = (float3(0.0 , break84_g69751.y , break84_g69751.z));
				half3 VertexPosOtherAxis82_g69751 = appendResult81_g69751;
				float4 temp_output_91_19_g69729 = TVE_MotionCoords;
				float3 localObjectPosition_UNITY_MATRIX_M14_g69741 = ObjectPosition_UNITY_MATRIX_M();
				#ifdef SHADEROPTIONS_CAMERA_RELATIVE_RENDERING
				float3 staticSwitch13_g69741 = ( localObjectPosition_UNITY_MATRIX_M14_g69741 + _WorldSpaceCameraPos );
				#else
				float3 staticSwitch13_g69741 = localObjectPosition_UNITY_MATRIX_M14_g69741;
				#endif
				half3 ObjectData20_g69742 = staticSwitch13_g69741;
				float3 ase_worldPos = GetAbsolutePositionWS( TransformObjectToWorld( (inputMesh.vertex).xyz ) );
				half3 WorldData19_g69742 = ase_worldPos;
				#ifdef TVE_FEATURE_BATCHING
				float3 staticSwitch14_g69742 = WorldData19_g69742;
				#else
				float3 staticSwitch14_g69742 = ObjectData20_g69742;
				#endif
				float3 temp_output_114_0_g69741 = staticSwitch14_g69742;
				float3 vertexToFrag4543_g69706 = temp_output_114_0_g69741;
				float3 ObjectPosition4422_g69706 = vertexToFrag4543_g69706;
				half2 UV94_g69729 = ( (temp_output_91_19_g69729).zw + ( (temp_output_91_19_g69729).xy * (ObjectPosition4422_g69706).xz ) );
				float temp_output_84_0_g69729 = _LayerMotionValue;
				float4 lerpResult107_g69729 = lerp( TVE_MotionParams , saturate( SAMPLE_TEXTURE2D_ARRAY_LOD( TVE_MotionTex, sampler_linear_repeat, UV94_g69729,temp_output_84_0_g69729, 0.0 ) ) , TVE_MotionUsage[(int)temp_output_84_0_g69729]);
				half4 Global_Motion_Params4344_g69706 = lerpResult107_g69729;
				float4 break322_g69745 = Global_Motion_Params4344_g69706;
				float3 appendResult397_g69745 = (float3(break322_g69745.x , 0.0 , break322_g69745.y));
				float3 temp_output_398_0_g69745 = (appendResult397_g69745*2.0 + -1.0);
				float3 ase_parentObjectScale = ( 1.0 / float3( length( GetWorldToObjectMatrix()[ 0 ].xyz ), length( GetWorldToObjectMatrix()[ 1 ].xyz ), length( GetWorldToObjectMatrix()[ 2 ].xyz ) ) );
				half2 Motion_DirectionOS39_g69706 = (( mul( GetWorldToObjectMatrix(), float4( temp_output_398_0_g69745 , 0.0 ) ).xyz * ase_parentObjectScale )).xz;
				half2 Input_DirectionOS358_g69733 = Motion_DirectionOS39_g69706;
				float temp_output_3572_0_g69706 = saturate( VertexPosition3564_g69706.y );
				half Mesh_Motion_1082_g69706 = ( temp_output_3572_0_g69706 * 2.0 );
				half Wind_Power369_g69745 = break322_g69745.z;
				half Motion_WindPower2223_g69706 = Wind_Power369_g69745;
				half3 Input_Position419_g69749 = -ObjectPosition4422_g69706;
				half2 Motion_DirectionWS4464_g69706 = (temp_output_398_0_g69745).xz;
				half2 Input_DirectionWS423_g69749 = Motion_DirectionWS4464_g69706;
				float Motion_Scale287_g69749 = ( _MotionScale_10 + 0.2 );
				half Global_Scale448_g69749 = TVE_NoiseParams.x;
				half Input_Speed62_g69749 = _MotionSpeed_10;
				half Global_Speed449_g69749 = TVE_NoiseParams.y;
				float mulTime426_g69749 = _TimeParameters.x * ( Input_Speed62_g69749 * Global_Speed449_g69749 );
				half Global_DistScale561_g69749 = TVE_NoiseParams.w;
				float3 break461_g69749 = ( Input_Position419_g69749 * Global_DistScale561_g69749 );
				half Global_DistAmplitude559_g69749 = TVE_NoiseParams.z;
				float Noise_Distortion469_g69749 = ( sin( ( break461_g69749.x + break461_g69749.z ) ) * Global_DistAmplitude559_g69749 );
				half Motion_Variation284_g69749 = 0.0;
				float2 temp_output_425_0_g69749 = ( ( (Input_Position419_g69749).xz * Input_DirectionWS423_g69749 * Motion_Scale287_g69749 * Global_Scale448_g69749 ) + ( mulTime426_g69749 + Noise_Distortion469_g69749 + Motion_Variation284_g69749 ) );
				float2 break500_g69749 = ( temp_output_425_0_g69749 * 0.1178 );
				float2 break494_g69749 = ( temp_output_425_0_g69749 * 0.1742 );
				half Input_WindPower327_g69749 = Motion_WindPower2223_g69706;
				float lerpResult430_g69749 = lerp( 1.4 , 0.4 , Input_WindPower327_g69749);
				half Global_MotionNoise34_g69706 = (pow( (( sin( ( break500_g69749.x + break500_g69749.y ) ) * sin( ( break494_g69749.x + break494_g69749.y ) ) )*0.4 + 0.6) , lerpResult430_g69749 )*1.2 + -0.2);
				half Motion_10_Amplitude2258_g69706 = ( _MotionAmplitude_10 * Mesh_Motion_1082_g69706 * Motion_WindPower2223_g69706 * Global_MotionNoise34_g69706 );
				half Input_BendingAmplitude376_g69733 = Motion_10_Amplitude2258_g69706;
				half Input_InteractionAmplitude58_g69733 = _InteractionAmplitude;
				half Input_MeshMotion_10321_g69733 = Mesh_Motion_1082_g69706;
				half Input_InteractionUseMask62_g69733 = _InteractionMaskValue;
				float lerpResult371_g69733 = lerp( 2.0 , Input_MeshMotion_10321_g69733 , Input_InteractionUseMask62_g69733);
				half ObjectData20_g69734 = lerpResult371_g69733;
				half WorldData19_g69734 = Input_MeshMotion_10321_g69733;
				#ifdef TVE_FEATURE_BATCHING
				float staticSwitch14_g69734 = WorldData19_g69734;
				#else
				float staticSwitch14_g69734 = ObjectData20_g69734;
				#endif
				half Motion_10_Interaction373_g69733 = ( Input_InteractionAmplitude58_g69733 * staticSwitch14_g69734 );
				half Interaction_Mask66_g69706 = ( break322_g69745.w * break322_g69745.w );
				float Input_InteractionMask330_g69733 = Interaction_Mask66_g69706;
				float lerpResult360_g69733 = lerp( Input_BendingAmplitude376_g69733 , Motion_10_Interaction373_g69733 , saturate( ( Input_InteractionAmplitude58_g69733 * Input_InteractionMask330_g69733 ) ));
				float2 break364_g69733 = ( Input_DirectionOS358_g69733 * lerpResult360_g69733 );
				half Motion_10_BendingZ190_g69706 = break364_g69733.y;
				half Angle44_g69751 = Motion_10_BendingZ190_g69706;
				half3 VertexPos40_g69748 = ( VertexPosRotationAxis50_g69751 + ( VertexPosOtherAxis82_g69751 * cos( Angle44_g69751 ) ) + ( cross( float3(1,0,0) , VertexPosOtherAxis82_g69751 ) * sin( Angle44_g69751 ) ) );
				float3 appendResult74_g69748 = (float3(0.0 , 0.0 , VertexPos40_g69748.z));
				half3 VertexPosRotationAxis50_g69748 = appendResult74_g69748;
				float3 break84_g69748 = VertexPos40_g69748;
				float3 appendResult81_g69748 = (float3(break84_g69748.x , break84_g69748.y , 0.0));
				half3 VertexPosOtherAxis82_g69748 = appendResult81_g69748;
				half Motion_10_BendingX216_g69706 = break364_g69733.x;
				half Angle44_g69748 = -Motion_10_BendingX216_g69706;
				float3 Vertex_Motion_Object833_g69706 = ( VertexPosRotationAxis50_g69748 + ( VertexPosOtherAxis82_g69748 * cos( Angle44_g69748 ) ) + ( cross( float3(0,0,1) , VertexPosOtherAxis82_g69748 ) * sin( Angle44_g69748 ) ) );
				float4 temp_output_94_19_g69712 = TVE_VertexCoords;
				half2 UV97_g69712 = ( (temp_output_94_19_g69712).zw + ( (temp_output_94_19_g69712).xy * (ObjectPosition4422_g69706).xz ) );
				float temp_output_84_0_g69712 = _LayerVertexValue;
				float4 lerpResult109_g69712 = lerp( TVE_VertexParams , SAMPLE_TEXTURE2D_ARRAY_LOD( TVE_VertexTex, sampler_linear_repeat, UV97_g69712,temp_output_84_0_g69712, 0.0 ) , TVE_VertexUsage[(int)temp_output_84_0_g69712]);
				half4 Global_Vertex_Params4413_g69706 = lerpResult109_g69712;
				half Global_VertexTex_Size174_g69706 = saturate( Global_Vertex_Params4413_g69706.w );
				float lerpResult346_g69706 = lerp( 1.0 , Global_VertexTex_Size174_g69706 , _GlobalSize);
				float3 appendResult3480_g69706 = (float3(lerpResult346_g69706 , lerpResult346_g69706 , lerpResult346_g69706));
				half3 Vertex_Size1741_g69706 = appendResult3480_g69706;
				half3 _Vector5 = half3(1,1,1);
				float3 Vertex_SizeFade1740_g69706 = _Vector5;
				half IsInitialized3811_g69706 = _IsInitialized;
				float3 Final_VertexPosition890_g69706 = ( ( ( ( Vertex_Motion_Object833_g69706 * Vertex_Size1741_g69706 * Vertex_SizeFade1740_g69706 ) - VertexPosition3564_g69706 ) * IsInitialized3811_g69706 ) + _DisableSRPBatcher );
				
				outputPackedVaryingsMeshToPS.ase_texcoord10.xyz = vertexToFrag4543_g69706;
				
				
				//setting value to unused interpolator channels and avoid initialization warnings
				outputPackedVaryingsMeshToPS.ase_texcoord10.w = 0;
				inputMesh.vertex.xyz += Final_VertexPosition890_g69706;
			...
			void Frag(  PackedVaryingsMeshToPS packedInput,	OUTPUT_GBUFFER(outGBuffer), out float outputDepth : SV_Depth  )
			{
				...
				half Vegetation_Type4515_g69706 = _VegetationMode;
				float4 output0 = 0;
				float4 output1 = 0;
				...
				half3 Main_Albedo_Raw4295_g69706 = o.Albedo;
				float dotResult4302_g69706 = dot( float3(0.2126,0.7152,0.0722) , Main_Albedo_Raw4295_g69706 );
				float3 temp_cast_0 = (dotResult4302_g69706).xxx;
				float4 break3589_g69706 = output0;
				half Main_Mask_Leaves3712_g69706 = break3589_g69706.g;
				float lerpResult4305_g69706 = lerp( _ImpostorBarkSaturationValue , _ImpostorLeafSaturationValue , Main_Mask_Leaves3712_g69706);
				float3 lerpResult4303_g69706 = lerp( temp_cast_0 , Main_Albedo_Raw4295_g69706 , lerpResult4305_g69706);
				float4 lerpResult4310_g69706 = lerp( _ImpostorBarkColor , _ImpostorLeafColor , Main_Mask_Leaves3712_g69706);
				float dotResult4323_g69706 = dot( float3(0.2126,0.7152,0.0722) , Main_Albedo_Raw4295_g69706 );
				float3 temp_cast_2 = (dotResult4323_g69706).xxx;
				float3 lerpResult4317_g69706 = lerp( temp_cast_2 , Main_Albedo_Raw4295_g69706 , _ImpostorGrassSaturationValue);
				float3 ifLocalVar18_g69739 = 0;
				UNITY_BRANCH 
				if( Vegetation_Type4515_g69706 > 0.5 )
				ifLocalVar18_g69739 = ( lerpResult4303_g69706 * (lerpResult4310_g69706).rgb );
				else if( Vegetation_Type4515_g69706 < 0.5 )
				ifLocalVar18_g69739 = ( lerpResult4317_g69706 * (_ImpostorGrassColor).rgb );
				half3 Main_Albedo3817_g69706 = ifLocalVar18_g69739;
				half3 Blend_Albedo4137_g69706 = Main_Albedo3817_g69706;
				half3 Blend_AlbedoTinted3958_g69706 = ( Blend_Albedo4137_g69706 * float3(1,1,1) );
				float dotResult4002_g69706 = dot( Blend_AlbedoTinted3958_g69706 , float3(0.2126,0.7152,0.0722) );
				float3 temp_cast_3 = (dotResult4002_g69706).xxx;
				float4 temp_output_91_19_g69725 = TVE_ColorsCoords;
				float3 temp_output_3563_0_g69706 = worldPos;
				float3 WorldPosition4027_g69706 = temp_output_3563_0_g69706;
				float3 vertexToFrag4543_g69706 = packedInput.ase_texcoord10.xyz;
				float3 ObjectPosition4422_g69706 = vertexToFrag4543_g69706;
				float3 lerpResult4478_g69706 = lerp( WorldPosition4027_g69706 , ObjectPosition4422_g69706 , _ColorsPositionMode);
				half2 UV94_g69725 = ( (temp_output_91_19_g69725).zw + ( (temp_output_91_19_g69725).xy * (lerpResult4478_g69706).xz ) );
				float temp_output_82_0_g69725 = _LayerColorsValue;
				float4 lerpResult108_g69725 = lerp( TVE_ColorsParams , SAMPLE_TEXTURE2D_ARRAY_LOD( TVE_ColorsTex, sampler_linear_repeat, UV94_g69725,temp_output_82_0_g69725, 0.0 ) , TVE_ColorsUsage[(int)temp_output_82_0_g69725]);
				half Global_ColorsTex_A1701_g69706 = saturate( (lerpResult108_g69725).a );
				half Global_Colors_Influence3998_g69706 = Global_ColorsTex_A1701_g69706;
				float3 lerpResult4004_g69706 = lerp( Blend_AlbedoTinted3958_g69706 , temp_cast_3 , Global_Colors_Influence3998_g69706);
				half3 Global_ColorsTex_RGB1700_g69706 = (lerpResult108_g69725).rgb;
				half3 Global_Colors3856_g69706 = ( Global_ColorsTex_RGB1700_g69706 * 4.594794 );
				float3 break111_g69753 = ObjectPosition4422_g69706;
				half Global_DynamicMode4535_g69706 = _VertexDynamicMode;
				half Input_DynamicMode120_g69753 = Global_DynamicMode4535_g69706;
				half Main_Variation_Or_Metallic3607_g69706 = break3589_g69706.r;
				half Input_Variation124_g69753 = Main_Variation_Or_Metallic3607_g69706;
				half ObjectData20_g69754 = frac( ( ( ( break111_g69753.x + break111_g69753.y + break111_g69753.z ) * ( 1.0 - Input_DynamicMode120_g69753 ) ) + Input_Variation124_g69753 ) );
				half WorldData19_g69754 = Input_Variation124_g69753;
				#ifdef TVE_FEATURE_BATCHING
				float staticSwitch14_g69754 = WorldData19_g69754;
				#else
				float staticSwitch14_g69754 = ObjectData20_g69754;
				#endif
				float clampResult129_g69753 = clamp( staticSwitch14_g69754 , 0.01 , 0.99 );
				half Global_MeshVariation4531_g69706 = clampResult129_g69753;
				float lerpResult4092_g69706 = lerp( 1.0 , ( Global_MeshVariation4531_g69706 * Global_MeshVariation4531_g69706 ) , _ColorsVariationValue);
				half Global_Colors_Value3999_g69706 = ( _GlobalColors * lerpResult4092_g69706 );
				half Main_Height_Or_Blend3609_g69706 = break3589_g69706.b;
				float temp_output_7_0_g69747 = _ColorsMaskMinValue;
				half Global_Colors_Mask4022_g69706 = ( saturate( ( ( Main_Height_Or_Blend3609_g69706 - temp_output_7_0_g69747 ) / ( _ColorsMaskMaxValue - temp_output_7_0_g69747 ) ) ) * Main_Mask_Leaves3712_g69706 );
				float3 lerpResult4007_g69706 = lerp( Blend_AlbedoTinted3958_g69706 , ( lerpResult4004_g69706 * Global_Colors3856_g69706 ) , ( Global_Colors_Value3999_g69706 * Global_Colors_Mask4022_g69706 ));
				float3 lerpResult4086_g69706 = lerp( Blend_Albedo4137_g69706 , lerpResult4007_g69706 , Main_Mask_Leaves3712_g69706);
				half3 Blend_AlbedoColored3711_g69706 = lerpResult4086_g69706;
				float3 temp_output_3681_0_g69706 = (_SubsurfaceColor).rgb;
				float dotResult4019_g69706 = dot( temp_output_3681_0_g69706 , float3(0.2126,0.7152,0.0722) );
				float3 temp_cast_6 = (dotResult4019_g69706).xxx;
				float3 lerpResult4018_g69706 = lerp( temp_output_3681_0_g69706 , temp_cast_6 , Global_Colors_Influence3998_g69706);
				float3 lerpResult4017_g69706 = lerp( temp_output_3681_0_g69706 , ( lerpResult4018_g69706 * Global_Colors3856_g69706 ) , ( Global_Colors_Value3999_g69706 * Global_Colors_Mask4022_g69706 ));
				half3 Subsurface_Color3656_g69706 = lerpResult4017_g69706;
				half Global_Subsurface4111_g69706 = TVE_SubsurfaceValue;
				half Subsurface_Intensity3684_g69706 = ( _SubsurfaceValue * Global_Subsurface4111_g69706 );
				float temp_output_7_0_g69724 = _SubsurfaceMaskMinValue;
				half Subsurface_Mask3666_g69706 = ( saturate( ( ( Main_Height_Or_Blend3609_g69706 - temp_output_7_0_g69724 ) / ( _SubsurfaceMaskMaxValue - temp_output_7_0_g69724 ) ) ) * Main_Mask_Leaves3712_g69706 );
				half3 Subsurface_Transmission3659_g69706 = ( Subsurface_Color3656_g69706 * Subsurface_Intensity3684_g69706 * Subsurface_Mask3666_g69706 );
				half3 MainLight_Direction4110_g69706 = TVE_MainLightDirection;
				float3 ase_worldPos = GetAbsolutePositionWS( packedInput.interp00 );
				float3 ase_worldViewDir = ( _WorldSpaceCameraPos.xyz - ase_worldPos );
				ase_worldViewDir = normalize(ase_worldViewDir);
				float3 normalizeResult3635_g69706 = normalize( ase_worldViewDir );
				float dotResult3631_g69706 = dot( -MainLight_Direction4110_g69706 , normalizeResult3635_g69706 );
				float saferPower3620_g69706 = abs( saturate( dotResult3631_g69706 ) );
				#ifdef UNITY_PASS_FORWARDADD
				float staticSwitch3636_g69706 = 0.0;
				#else
				float staticSwitch3636_g69706 = ( pow( saferPower3620_g69706 , _SubsurfaceAngleValue ) * _SubsurfaceScatteringValue );
				#endif
				half Mask_Subsurface_View3614_g69706 = staticSwitch3636_g69706;
				half3 Subsurface_Approximation3702_g69706 = ( Subsurface_Transmission3659_g69706 * Blend_AlbedoColored3711_g69706 * Mask_Subsurface_View3614_g69706 );
				half3 Albedo_Subsurface3874_g69706 = ( Blend_AlbedoColored3711_g69706 + Subsurface_Approximation3702_g69706 );
				half3 Global_OverlayColor1758_g69706 = (TVE_OverlayColor).rgb;
				half3 World_Normal3638_g69706 = o.Normal;
				float lerpResult4521_g69706 = lerp( Main_Height_Or_Blend3609_g69706 , World_Normal3638_g69706.y , Vegetation_Type4515_g69706);
				half Main_AlbedoTex_G3807_g69706 = Main_Albedo_Raw4295_g69706.y;
				float4 temp_output_93_19_g69707 = TVE_ExtrasCoords;
				float3 lerpResult4483_g69706 = lerp( WorldPosition4027_g69706 , ObjectPosition4422_g69706 , _ExtrasPositionMode);
				half2 UV96_g69707 = ( (temp_output_93_19_g69707).zw + ( (temp_output_93_19_g69707).xy * (lerpResult4483_g69706).xz ) );
				float temp_output_84_0_g69707 = _LayerExtrasValue;
				float4 lerpResult109_g69707 = lerp( TVE_ExtrasParams , SAMPLE_TEXTURE2D_ARRAY_LOD( TVE_ExtrasTex, sampler_linear_repeat, UV96_g69707,temp_output_84_0_g69707, 0.0 ) , TVE_ExtrasUsage[(int)temp_output_84_0_g69707]);
				float4 break89_g69707 = lerpResult109_g69707;
				half Global_ExtrasTex_Overlay156_g69706 = break89_g69707.b;
				float temp_output_3774_0_g69706 = ( _GlobalOverlay * Global_ExtrasTex_Overlay156_g69706 );
				float lerpResult3746_g69706 = lerp( 1.0 , Global_MeshVariation4531_g69706 , _OverlayVariationValue);
				half Overlay_Commons3739_g69706 = ( temp_output_3774_0_g69706 * lerpResult3746_g69706 );
				float temp_output_7_0_g69738 = _OverlayMaskMinValue;
				half Overlay_Mask3762_g69706 = saturate( ( ( ( ( ( lerpResult4521_g69706 * 0.5 ) + Main_AlbedoTex_G3807_g69706 ) * Overlay_Commons3739_g69706 ) - temp_output_7_0_g69738 ) / ( _OverlayMaskMaxValue - temp_output_7_0_g69738 ) ) );
				float3 lerpResult3875_g69706 = lerp( Albedo_Subsurface3874_g69706 , Global_OverlayColor1758_g69706 , Overlay_Mask3762_g69706);
				half3 Final_Albedo4100_g69706 = lerpResult3875_g69706;
				half IsInitialized3811_g69706 = _IsInitialized;
				float3 lerpResult3815_g69706 = lerp( float3( 1,0,0 ) , Final_Albedo4100_g69706 , IsInitialized3811_g69706);
				
				float3 temp_cast_9 = (( 0.04 * _render_specular )).xxx;
				
				float3 hdEmission4376_g69706 = ASEGetEmissionHDRColor(_EmissiveColor.rgb,_EmissiveIntensityParams.x,_EmissiveExposureValue,GetInverseCurrentExposureMultiplier());
				half Global_ExtrasTex_Emissive4408_g69706 = break89_g69707.r;
				float lerpResult4417_g69706 = lerp( 1.0 , Global_ExtrasTex_Emissive4408_g69706 , _GlobalEmissive);
				half3 Final_Emissive4365_g69706 = ( (( hdEmission4376_g69706 * output1 )).rgb * lerpResult4417_g69706 );
				
				half Main_Mask_Smoothness3820_g69706 = break3589_g69706.a;
				half Main_Smoothness3838_g69706 = ( Main_Mask_Smoothness3820_g69706 * _ImpostorSmoothnessValue );
				half Global_ExtrasTex_Wetness305_g69706 = break89_g69707.g;
				float lerpResult3892_g69706 = lerp( Main_Smoothness3838_g69706 , saturate( ( Main_Smoothness3838_g69706 + Global_ExtrasTex_Wetness305_g69706 ) ) , _GlobalWetness);
				half Final_Smoothness3898_g69706 = lerpResult3892_g69706;
				
				float temp_output_3577_0_g69706 = o.Alpha;
				float localCustomAlphaClipAlways4430_g69706 = ( temp_output_3577_0_g69706 );
				half Global_ExtrasTex_Alpha1033_g69706 = saturate( break89_g69707.a );
				float lerpResult4544_g69706 = lerp( 0.0 , Global_MeshVariation4531_g69706 , _AlphaVariationValue);
				half Global_Alpha_Variation4546_g69706 = lerpResult4544_g69706;
				float lerpResult4053_g69706 = lerp( 1.0 , ( ( Global_ExtrasTex_Alpha1033_g69706 - Global_Alpha_Variation4546_g69706 ) + 0.09 ) , _GlobalAlpha);
				float lerpResult4075_g69706 = lerp( 1.0 , lerpResult4053_g69706 , Main_Mask_Leaves3712_g69706);
				half Final_Alpha4102_g69706 = lerpResult4075_g69706;
				float Alpha4430_g69706 = Final_Alpha4102_g69706;
				{
				clip(Alpha4430_g69706 - 0.1);
				}
				float temp_output_3_0_g69750 = localCustomAlphaClipAlways4430_g69706;
				half Offest27_g69750 = 0.0;
				half Feather30_g69750 = 0.2;
				

                surfaceDescription.Albedo = lerpResult3815_g69706;
                o.Normal = World_Normal3638_g69706;
				...
				surfaceDescription.Emission = Final_Emissive4365_g69706;
                surfaceDescription.Smoothness = Final_Smoothness3898_g69706;
                surfaceDescription.Occlusion = 1;
				surfaceDescription.Alpha = ( ( ( temp_output_3_0_g69750 - Offest27_g69750 ) / ( max( fwidth( temp_output_3_0_g69750 ) , 0.001 ) + Feather30_g69750 ) ) + Offest27_g69750 );
		...
		Pass
        {
			...
			PackedVaryingsMeshToPS Vert(AttributesMesh inputMesh  )
			{
				...
				outputPackedVaryingsMeshToPS.ase_texcoord5.xyz = vertexToFrag4543_g69706;
			...
			)
			{
				...
				float3 temp_output_3563_0_g69706 = worldPos;
				float3 WorldPosition4027_g69706 = temp_output_3563_0_g69706;
				float3 vertexToFrag4543_g69706 = packedInput.ase_texcoord5.xyz;
				float3 ObjectPosition4422_g69706 = vertexToFrag4543_g69706;
				float3 lerpResult4483_g69706 = lerp( WorldPosition4027_g69706 , ObjectPosition4422_g69706 , _ExtrasPositionMode);
				half2 UV96_g69707 = ( (temp_output_93_19_g69707).zw + ( (temp_output_93_19_g69707).xy * (lerpResult4483_g69706).xz ) );
				float temp_output_84_0_g69707 = _LayerExtrasValue;
        ...
        Pass
        {
			...
			PackedVaryingsMeshToPS Vert(AttributesMesh inputMesh )
			{
				...
				outputPackedVaryingsMeshToPS.ase_texcoord13.xyz = vertexToFrag4543_g69706;
			...
			)
			{
				...
				float3 temp_output_3563_0_g69706 = worldPos;
				float3 WorldPosition4027_g69706 = temp_output_3563_0_g69706;
				float3 vertexToFrag4543_g69706 = packedInput.ase_texcoord13.xyz;
				float3 ObjectPosition4422_g69706 = vertexToFrag4543_g69706;
				float3 lerpResult4483_g69706 = lerp( WorldPosition4027_g69706 , ObjectPosition4422_g69706 , _ExtrasPositionMode);
				half2 UV96_g69707 = ( (temp_output_93_19_g69707).zw + ( (temp_output_93_19_g69707).xy * (lerpResult4483_g69706).xz ) );
				float temp_output_84_0_g69707 = _LayerExtrasValue;
		...
		Pass
        {
			...
			PackedVaryingsMeshToPS Vert(AttributesMesh inputMesh )
			{
				...
				outputPackedVaryingsMeshToPS.ase_texcoord11.xyz = vertexToFrag4543_g69706;
			...
			)
			{
				...
				float3 temp_output_3563_0_g69706 = worldPos;
				float3 WorldPosition4027_g69706 = temp_output_3563_0_g69706;
				float3 vertexToFrag4543_g69706 = packedInput.ase_texcoord11.xyz;
				float3 ObjectPosition4422_g69706 = vertexToFrag4543_g69706;
				float3 lerpResult4478_g69706 = lerp( WorldPosition4027_g69706 , ObjectPosition4422_g69706 , _ColorsPositionMode);
				half2 UV94_g69725 = ( (temp_output_91_19_g69725).zw + ( (temp_output_91_19_g69725).xy * (lerpResult4478_g69706).xz ) );
				float temp_output_82_0_g69725 = _LayerColorsValue;
...
/*ASEBEGIN
Version=18934
1920;0;1920;1029;2124.899;1070.423;1;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;409;-1664,-640;Half;False;Property;_RenderCoverage;Impostor Alpha To Mask;20;1;[Enum];Create;False;0;2;Off;0;On;1;0;True;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;407;-1152,-768;Half;False;Property;_IsStandardShader;_IsStandardShader;142;1;[HideInInspector];Create;True;0;0;0;True;0;False;1;1;1;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;387;-1408,-768;Half;False;Property;_IsVegetationShader;_IsVegetationShader;143;1;[HideInInspector];Create;True;0;0;0;True;0;False;1;1;1;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;367;-1664,512;Inherit;False;Is ShaderType;-1;;69756;90bdd02d483309144a404aee7f41383d;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;408;-1408,-640;Inherit;False;Property;_RenderSpecular;Impostor Render Specular;19;1;[Enum];Create;False;0;2;Off;0;On;1;0;True;0;False;1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;385;-1024,-256;Inherit;False;Base Impostor;22;;69706;47a437226c28ea34bad309b04e5582cd;31,4299,0,4398,1,4399,1,4400,1,4405,1,4404,1,4406,1,4412,1,4410,1,4447,1,4020,1,4010,1,3868,1,4338,1,4434,1,4539,1,4336,1,3881,1,3891,1,4416,1,1745,1,3479,0,3707,1,3952,0,4496,0,4186,0,1742,0,3484,0,860,1,2260,1,2261,1;7;3592;COLOR;0,0,0,0;False;4370;COLOR;0,0,0,0;False;3583;FLOAT3;0,0,0;False;3574;FLOAT3;0,0,0;False;3577;FLOAT;0;False;3563;FLOAT3;0,0,0;False;3964;FLOAT3;0,0,0;False;15;FLOAT3;3597;FLOAT3;3594;FLOAT3;4372;FLOAT;4373;FLOAT;3595;FLOAT;4119;FLOAT;3598;FLOAT;3980;FLOAT3;3974;FLOAT;3973;FLOAT;3975;FLOAT;4334;FLOAT;3593;FLOAT;4335;FLOAT3;534
Node;AmplifyShaderEditor.FunctionNode;406;-1408,512;Inherit;False;Define Pipeline HD AI;-1;;69705;4bfc56eb4c68eb8429d853b857b9fcbe;0;0;1;FLOAT;529
Node;AmplifyShaderEditor.FunctionNode;404;-768,-768;Inherit;False;Compile Impostors;-1;;69704;1cfd52e266bd86c47a094d0358cb5b93;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;403;-576,-768;Inherit;False;Compile All Shaders;-1;;69755;e67c8238031dbf04ab79a5d4d63d1b4f;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;402;-592,-256;Float;False;False;-1;2;ASEMaterialInspector;0;1;New Amplify Shader;4e5791d7c677cf540a160f0a09e2385a;True;Forward;0;7;Forward;0;False;True;1;1;False;-1;0;False;-1;0;1;False;-1;0;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;-1;False;False;False;False;False;False;False;False;False;False;False;True;1;False;-1;True;3;False;-1;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;True;8;d3d11;metal;vulkan;xboxone;xboxseries;ps4;playstation;switch;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;10;False;-1;255;False;-1;14;False;-1;7;False;-1;3;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;False;False;False;True;1;LightMode=Forward;False;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;395;-592,-256;Float;False;True;-1;2;TVEShaderCoreGUI;0;21;BOXOPHOBIC/The Vegetation Engine/Impostors/Vegetation Standard Lit (Octahedron);4e5791d7c677cf540a160f0a09e2385a;True;GBuffer;0;0;GBuffer;26;False;True;1;1;False;-1;0;False;-1;0;1;False;-1;0;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;-1;False;False;False;False;False;False;False;False;False;False;False;True;1;False;-1;True;3;False;-1;False;True;4;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;ImpostorType=Octahedron;True;5;True;8;d3d11;metal;vulkan;xboxone;xboxseries;ps4;playstation;switch;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;10;False;-1;255;False;-1;14;False;-1;7;False;-1;3;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;False;False;False;True;1;LightMode=GBuffer;False;False;0;;0;0;Standard;16;Material Type,InvertActionOnDeselection;4;0;Energy Conserving Specular,InvertActionOnDeselection;1;0;Transmission,InvertActionOnDeselection;0;0;Surface Type;0;0;Alpha Cutoff;0;0;Receive Decals;0;0;Receives SSR;0;0;Specular AA;0;0;Specular Occlusion Mode;0;0;Distortion;0;0;Distortion Mode;0;0;Distortion Depth Test;0;0;Blend Preserves Specular;1;0;Fog;1;0;Draw Before Refraction;0;0;Refraction Model;0;0;0;8;True;True;True;True;True;False;False;True;False;;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;398;-592,-256;Float;False;False;-1;2;ASEMaterialInspector;0;1;New Amplify Shader;4e5791d7c677cf540a160f0a09e2385a;True;ShadowCaster;0;3;ShadowCaster;0;False;True;1;1;False;-1;0;False;-1;0;1;False;-1;0;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;-1;False;False;False;False;False;False;False;False;False;False;False;True;1;False;-1;True;3;False;-1;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;True;8;d3d11;metal;vulkan;xboxone;xboxseries;ps4;playstation;switch;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;False;False;False;False;0;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=ShadowCaster;False;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;396;-592,-256;Float;False;False;-1;2;ASEMaterialInspector;0;1;New Amplify Shader;4e5791d7c677cf540a160f0a09e2385a;True;SceneSelectionPass;0;1;SceneSelectionPass;0;False;True;1;1;False;-1;0;False;-1;0;1;False;-1;0;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;-1;False;False;False;False;False;False;False;False;False;False;False;True;1;False;-1;True;3;False;-1;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;True;8;d3d11;metal;vulkan;xboxone;xboxseries;ps4;playstation;switch;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;False;False;False;False;0;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=SceneSelectionPass;False;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;401;-592,-256;Float;False;False;-1;2;ASEMaterialInspector;0;1;New Amplify Shader;4e5791d7c677cf540a160f0a09e2385a;True;Distortion;0;6;Distortion;2;False;True;1;1;False;-1;0;False;-1;0;1;False;-1;0;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;-1;False;False;False;False;False;False;False;False;False;False;False;True;1;False;-1;True;3;False;-1;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;True;8;d3d11;metal;vulkan;xboxone;xboxseries;ps4;playstation;switch;0;False;True;4;1;False;-1;1;False;-1;4;1;False;-1;1;False;-1;True;1;False;-1;5;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;False;-1;False;True;1;LightMode=DistortionVectors;False;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;397;-592,-256;Float;False;False;-1;2;ASEMaterialInspector;0;1;New Amplify Shader;4e5791d7c677cf540a160f0a09e2385a;True;META;0;2;META;0;False;True;1;1;False;-1;0;False;-1;0;1;False;-1;0;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;-1;False;False;False;False;False;False;False;False;False;False;False;True;1;False;-1;True;3;False;-1;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;True;8;d3d11;metal;vulkan;xboxone;xboxseries;ps4;playstation;switch;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;2;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=Meta;False;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;400;-592,-256;Float;False;False;-1;2;ASEMaterialInspector;0;1;New Amplify Shader;4e5791d7c677cf540a160f0a09e2385a;True;Motion Vectors;0;5;Motion Vectors;0;False;True;1;1;False;-1;0;False;-1;0;1;False;-1;0;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;-1;False;False;False;False;False;False;False;False;False;False;False;True;1;False;-1;True;3;False;-1;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;True;8;d3d11;metal;vulkan;xboxone;xboxseries;ps4;playstation;switch;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;40;False;-1;255;False;-1;40;False;-1;7;False;-1;3;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;False;False;False;True;1;LightMode=MotionVectors;False;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;399;-592,-256;Float;False;False;-1;2;ASEMaterialInspector;0;1;New Amplify Shader;4e5791d7c677cf540a160f0a09e2385a;True;DepthOnly;0;4;DepthOnly;0;False;True;1;1;False;-1;0;False;-1;0;1;False;-1;0;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;-1;False;False;False;False;False;False;False;False;False;False;False;True;1;False;-1;True;3;False;-1;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;True;8;d3d11;metal;vulkan;xboxone;xboxseries;ps4;playstation;switch;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=DepthOnly;False;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
...
ASEEND*/
//CHKSM=0491D04BD4FCA5DA10621A61D00B7EAFA457AC92
