    ...
    SubShader
    {
		...
		Pass
        {
			...
			PackedVaryingsMeshToPS Vert(AttributesMesh inputMesh )
			{
				...
				float3 viewToObj3965_g69595 = mul( GetWorldToObjectMatrix(), mul( UNITY_MATRIX_I_V , float4( outputPackedVaryingsMeshToPS.viewPos99.xyz, 1 ) ) ).xyz;
				float3 VertexPosition3564_g69595 = viewToObj3965_g69595;
				half3 VertexPos40_g69640 = VertexPosition3564_g69595;
				float3 appendResult74_g69640 = (float3(VertexPos40_g69640.x , 0.0 , 0.0));
				half3 VertexPosRotationAxis50_g69640 = appendResult74_g69640;
				float3 break84_g69640 = VertexPos40_g69640;
				float3 appendResult81_g69640 = (float3(0.0 , break84_g69640.y , break84_g69640.z));
				half3 VertexPosOtherAxis82_g69640 = appendResult81_g69640;
				float4 temp_output_91_19_g69618 = TVE_MotionCoords;
				float3 localObjectPosition_UNITY_MATRIX_M14_g69630 = ObjectPosition_UNITY_MATRIX_M();
				#ifdef SHADEROPTIONS_CAMERA_RELATIVE_RENDERING
				float3 staticSwitch13_g69630 = ( localObjectPosition_UNITY_MATRIX_M14_g69630 + _WorldSpaceCameraPos );
				#else
				float3 staticSwitch13_g69630 = localObjectPosition_UNITY_MATRIX_M14_g69630;
				#endif
				half3 ObjectData20_g69631 = staticSwitch13_g69630;
				float3 ase_worldPos = GetAbsolutePositionWS( TransformObjectToWorld( (inputMesh.vertex).xyz ) );
				half3 WorldData19_g69631 = ase_worldPos;
				#ifdef TVE_FEATURE_BATCHING
				float3 staticSwitch14_g69631 = WorldData19_g69631;
				#else
				float3 staticSwitch14_g69631 = ObjectData20_g69631;
				#endif
				float3 temp_output_114_0_g69630 = staticSwitch14_g69631;
				float3 vertexToFrag4543_g69595 = temp_output_114_0_g69630;
				float3 ObjectPosition4422_g69595 = vertexToFrag4543_g69595;
				half2 UV94_g69618 = ( (temp_output_91_19_g69618).zw + ( (temp_output_91_19_g69618).xy * (ObjectPosition4422_g69595).xz ) );
				float temp_output_84_0_g69618 = _LayerMotionValue;
				float4 lerpResult107_g69618 = lerp( TVE_MotionParams , saturate( SAMPLE_TEXTURE2D_ARRAY_LOD( TVE_MotionTex, sampler_linear_repeat, UV94_g69618,temp_output_84_0_g69618, 0.0 ) ) , TVE_MotionUsage[(int)temp_output_84_0_g69618]);
				half4 Global_Motion_Params4344_g69595 = lerpResult107_g69618;
				float4 break322_g69634 = Global_Motion_Params4344_g69595;
				float3 appendResult397_g69634 = (float3(break322_g69634.x , 0.0 , break322_g69634.y));
				float3 temp_output_398_0_g69634 = (appendResult397_g69634*2.0 + -1.0);
				float3 ase_parentObjectScale = ( 1.0 / float3( length( GetWorldToObjectMatrix()[ 0 ].xyz ), length( GetWorldToObjectMatrix()[ 1 ].xyz ), length( GetWorldToObjectMatrix()[ 2 ].xyz ) ) );
				half2 Motion_DirectionOS39_g69595 = (( mul( GetWorldToObjectMatrix(), float4( temp_output_398_0_g69634 , 0.0 ) ).xyz * ase_parentObjectScale )).xz;
				half2 Input_DirectionOS358_g69622 = Motion_DirectionOS39_g69595;
				float temp_output_3572_0_g69595 = saturate( VertexPosition3564_g69595.y );
				half Mesh_Motion_1082_g69595 = ( temp_output_3572_0_g69595 * 2.0 );
				half Wind_Power369_g69634 = break322_g69634.z;
				half Motion_WindPower2223_g69595 = Wind_Power369_g69634;
				half3 Input_Position419_g69638 = -ObjectPosition4422_g69595;
				half2 Motion_DirectionWS4464_g69595 = (temp_output_398_0_g69634).xz;
				half2 Input_DirectionWS423_g69638 = Motion_DirectionWS4464_g69595;
				float Motion_Scale287_g69638 = ( _MotionScale_10 + 0.2 );
				half Global_Scale448_g69638 = TVE_NoiseParams.x;
				half Input_Speed62_g69638 = _MotionSpeed_10;
				half Global_Speed449_g69638 = TVE_NoiseParams.y;
				float mulTime426_g69638 = _TimeParameters.x * ( Input_Speed62_g69638 * Global_Speed449_g69638 );
				half Global_DistScale561_g69638 = TVE_NoiseParams.w;
				float3 break461_g69638 = ( Input_Position419_g69638 * Global_DistScale561_g69638 );
				half Global_DistAmplitude559_g69638 = TVE_NoiseParams.z;
				float Noise_Distortion469_g69638 = ( sin( ( break461_g69638.x + break461_g69638.z ) ) * Global_DistAmplitude559_g69638 );
				half Motion_Variation284_g69638 = 0.0;
				float2 temp_output_425_0_g69638 = ( ( (Input_Position419_g69638).xz * Input_DirectionWS423_g69638 * Motion_Scale287_g69638 * Global_Scale448_g69638 ) + ( mulTime426_g69638 + Noise_Distortion469_g69638 + Motion_Variation284_g69638 ) );
				float2 break500_g69638 = ( temp_output_425_0_g69638 * 0.1178 );
				float2 break494_g69638 = ( temp_output_425_0_g69638 * 0.1742 );
				half Input_WindPower327_g69638 = Motion_WindPower2223_g69595;
				float lerpResult430_g69638 = lerp( 1.4 , 0.4 , Input_WindPower327_g69638);
				half Global_MotionNoise34_g69595 = (pow( (( sin( ( break500_g69638.x + break500_g69638.y ) ) * sin( ( break494_g69638.x + break494_g69638.y ) ) )*0.4 + 0.6) , lerpResult430_g69638 )*1.2 + -0.2);
				half Motion_10_Amplitude2258_g69595 = ( _MotionAmplitude_10 * Mesh_Motion_1082_g69595 * Motion_WindPower2223_g69595 * Global_MotionNoise34_g69595 );
				half Input_BendingAmplitude376_g69622 = Motion_10_Amplitude2258_g69595;
				half Input_InteractionAmplitude58_g69622 = _InteractionAmplitude;
				half Input_MeshMotion_10321_g69622 = Mesh_Motion_1082_g69595;
				half Input_InteractionUseMask62_g69622 = _InteractionMaskValue;
				float lerpResult371_g69622 = lerp( 2.0 , Input_MeshMotion_10321_g69622 , Input_InteractionUseMask62_g69622);
				half ObjectData20_g69623 = lerpResult371_g69622;
				half WorldData19_g69623 = Input_MeshMotion_10321_g69622;
				#ifdef TVE_FEATURE_BATCHING
				float staticSwitch14_g69623 = WorldData19_g69623;
				#else
				float staticSwitch14_g69623 = ObjectData20_g69623;
				#endif
				half Motion_10_Interaction373_g69622 = ( Input_InteractionAmplitude58_g69622 * staticSwitch14_g69623 );
				half Interaction_Mask66_g69595 = ( break322_g69634.w * break322_g69634.w );
				float Input_InteractionMask330_g69622 = Interaction_Mask66_g69595;
				float lerpResult360_g69622 = lerp( Input_BendingAmplitude376_g69622 , Motion_10_Interaction373_g69622 , saturate( ( Input_InteractionAmplitude58_g69622 * Input_InteractionMask330_g69622 ) ));
				float2 break364_g69622 = ( Input_DirectionOS358_g69622 * lerpResult360_g69622 );
				half Motion_10_BendingZ190_g69595 = break364_g69622.y;
				half Angle44_g69640 = Motion_10_BendingZ190_g69595;
				half3 VertexPos40_g69637 = ( VertexPosRotationAxis50_g69640 + ( VertexPosOtherAxis82_g69640 * cos( Angle44_g69640 ) ) + ( cross( float3(1,0,0) , VertexPosOtherAxis82_g69640 ) * sin( Angle44_g69640 ) ) );
				float3 appendResult74_g69637 = (float3(0.0 , 0.0 , VertexPos40_g69637.z));
				half3 VertexPosRotationAxis50_g69637 = appendResult74_g69637;
				float3 break84_g69637 = VertexPos40_g69637;
				float3 appendResult81_g69637 = (float3(break84_g69637.x , break84_g69637.y , 0.0));
				half3 VertexPosOtherAxis82_g69637 = appendResult81_g69637;
				half Motion_10_BendingX216_g69595 = break364_g69622.x;
				half Angle44_g69637 = -Motion_10_BendingX216_g69595;
				float3 Vertex_Motion_Object833_g69595 = ( VertexPosRotationAxis50_g69637 + ( VertexPosOtherAxis82_g69637 * cos( Angle44_g69637 ) ) + ( cross( float3(0,0,1) , VertexPosOtherAxis82_g69637 ) * sin( Angle44_g69637 ) ) );
				float4 temp_output_94_19_g69601 = TVE_VertexCoords;
				half2 UV97_g69601 = ( (temp_output_94_19_g69601).zw + ( (temp_output_94_19_g69601).xy * (ObjectPosition4422_g69595).xz ) );
				float temp_output_84_0_g69601 = _LayerVertexValue;
				float4 lerpResult109_g69601 = lerp( TVE_VertexParams , SAMPLE_TEXTURE2D_ARRAY_LOD( TVE_VertexTex, sampler_linear_repeat, UV97_g69601,temp_output_84_0_g69601, 0.0 ) , TVE_VertexUsage[(int)temp_output_84_0_g69601]);
				half4 Global_Vertex_Params4413_g69595 = lerpResult109_g69601;
				half Global_VertexTex_Size174_g69595 = saturate( Global_Vertex_Params4413_g69595.w );
				float lerpResult346_g69595 = lerp( 1.0 , Global_VertexTex_Size174_g69595 , _GlobalSize);
				float3 appendResult3480_g69595 = (float3(lerpResult346_g69595 , lerpResult346_g69595 , lerpResult346_g69595));
				half3 Vertex_Size1741_g69595 = appendResult3480_g69595;
				half3 _Vector5 = half3(1,1,1);
				float3 Vertex_SizeFade1740_g69595 = _Vector5;
				half IsInitialized3811_g69595 = _IsInitialized;
				float3 Final_VertexPosition890_g69595 = ( ( ( ( Vertex_Motion_Object833_g69595 * Vertex_Size1741_g69595 * Vertex_SizeFade1740_g69595 ) - VertexPosition3564_g69595 ) * IsInitialized3811_g69595 ) + _DisableSRPBatcher );
				
				outputPackedVaryingsMeshToPS.ase_texcoord10.xyz = vertexToFrag4543_g69595;
				
				
				//setting value to unused interpolator channels and avoid initialization warnings
				outputPackedVaryingsMeshToPS.ase_texcoord10.w = 0;
				inputMesh.vertex.xyz += Final_VertexPosition890_g69595;
			...
			void Frag(  PackedVaryingsMeshToPS packedInput,	OUTPUT_GBUFFER(outGBuffer), out float outputDepth : SV_Depth  )
			{
				...
				half Vegetation_Type4515_g69595 = _VegetationMode;
				float4 output0 = 0;
				float4 output1 = 0;
				...
				half3 Main_Albedo_Raw4295_g69595 = o.Albedo;
				float dotResult4302_g69595 = dot( float3(0.2126,0.7152,0.0722) , Main_Albedo_Raw4295_g69595 );
				float3 temp_cast_0 = (dotResult4302_g69595).xxx;
				float4 break3589_g69595 = output0;
				half Main_Mask_Leaves3712_g69595 = break3589_g69595.g;
				float lerpResult4305_g69595 = lerp( _ImpostorBarkSaturationValue , _ImpostorLeafSaturationValue , Main_Mask_Leaves3712_g69595);
				float3 lerpResult4303_g69595 = lerp( temp_cast_0 , Main_Albedo_Raw4295_g69595 , lerpResult4305_g69595);
				float4 lerpResult4310_g69595 = lerp( _ImpostorBarkColor , _ImpostorLeafColor , Main_Mask_Leaves3712_g69595);
				float dotResult4323_g69595 = dot( float3(0.2126,0.7152,0.0722) , Main_Albedo_Raw4295_g69595 );
				float3 temp_cast_2 = (dotResult4323_g69595).xxx;
				float3 lerpResult4317_g69595 = lerp( temp_cast_2 , Main_Albedo_Raw4295_g69595 , _ImpostorGrassSaturationValue);
				float3 ifLocalVar18_g69628 = 0;
				UNITY_BRANCH 
				if( Vegetation_Type4515_g69595 > 0.5 )
				ifLocalVar18_g69628 = ( lerpResult4303_g69595 * (lerpResult4310_g69595).rgb );
				else if( Vegetation_Type4515_g69595 < 0.5 )
				ifLocalVar18_g69628 = ( lerpResult4317_g69595 * (_ImpostorGrassColor).rgb );
				half3 Main_Albedo3817_g69595 = ifLocalVar18_g69628;
				half3 Blend_Albedo4137_g69595 = Main_Albedo3817_g69595;
				half3 Blend_AlbedoTinted3958_g69595 = ( Blend_Albedo4137_g69595 * float3(1,1,1) );
				float dotResult4002_g69595 = dot( Blend_AlbedoTinted3958_g69595 , float3(0.2126,0.7152,0.0722) );
				float3 temp_cast_3 = (dotResult4002_g69595).xxx;
				float4 temp_output_91_19_g69614 = TVE_ColorsCoords;
				float3 temp_output_3563_0_g69595 = worldPos;
				float3 WorldPosition4027_g69595 = temp_output_3563_0_g69595;
				float3 vertexToFrag4543_g69595 = packedInput.ase_texcoord10.xyz;
				float3 ObjectPosition4422_g69595 = vertexToFrag4543_g69595;
				float3 lerpResult4478_g69595 = lerp( WorldPosition4027_g69595 , ObjectPosition4422_g69595 , _ColorsPositionMode);
				half2 UV94_g69614 = ( (temp_output_91_19_g69614).zw + ( (temp_output_91_19_g69614).xy * (lerpResult4478_g69595).xz ) );
				float temp_output_82_0_g69614 = _LayerColorsValue;
				float4 lerpResult108_g69614 = lerp( TVE_ColorsParams , SAMPLE_TEXTURE2D_ARRAY_LOD( TVE_ColorsTex, sampler_linear_repeat, UV94_g69614,temp_output_82_0_g69614, 0.0 ) , TVE_ColorsUsage[(int)temp_output_82_0_g69614]);
				half Global_ColorsTex_A1701_g69595 = saturate( (lerpResult108_g69614).a );
				half Global_Colors_Influence3998_g69595 = Global_ColorsTex_A1701_g69595;
				float3 lerpResult4004_g69595 = lerp( Blend_AlbedoTinted3958_g69595 , temp_cast_3 , Global_Colors_Influence3998_g69595);
				half3 Global_ColorsTex_RGB1700_g69595 = (lerpResult108_g69614).rgb;
				half3 Global_Colors3856_g69595 = ( Global_ColorsTex_RGB1700_g69595 * 4.594794 );
				float3 break111_g69642 = ObjectPosition4422_g69595;
				half Global_DynamicMode4535_g69595 = _VertexDynamicMode;
				half Input_DynamicMode120_g69642 = Global_DynamicMode4535_g69595;
				half Main_Variation_Or_Metallic3607_g69595 = break3589_g69595.r;
				half Input_Variation124_g69642 = Main_Variation_Or_Metallic3607_g69595;
				half ObjectData20_g69643 = frac( ( ( ( break111_g69642.x + break111_g69642.y + break111_g69642.z ) * ( 1.0 - Input_DynamicMode120_g69642 ) ) + Input_Variation124_g69642 ) );
				half WorldData19_g69643 = Input_Variation124_g69642;
				#ifdef TVE_FEATURE_BATCHING
				float staticSwitch14_g69643 = WorldData19_g69643;
				#else
				float staticSwitch14_g69643 = ObjectData20_g69643;
				#endif
				float clampResult129_g69642 = clamp( staticSwitch14_g69643 , 0.01 , 0.99 );
				half Global_MeshVariation4531_g69595 = clampResult129_g69642;
				float lerpResult4092_g69595 = lerp( 1.0 , ( Global_MeshVariation4531_g69595 * Global_MeshVariation4531_g69595 ) , _ColorsVariationValue);
				half Global_Colors_Value3999_g69595 = ( _GlobalColors * lerpResult4092_g69595 );
				half Main_Height_Or_Blend3609_g69595 = break3589_g69595.b;
				float temp_output_7_0_g69636 = _ColorsMaskMinValue;
				half Global_Colors_Mask4022_g69595 = ( saturate( ( ( Main_Height_Or_Blend3609_g69595 - temp_output_7_0_g69636 ) / ( _ColorsMaskMaxValue - temp_output_7_0_g69636 ) ) ) * Main_Mask_Leaves3712_g69595 );
				float3 lerpResult4007_g69595 = lerp( Blend_AlbedoTinted3958_g69595 , ( lerpResult4004_g69595 * Global_Colors3856_g69595 ) , ( Global_Colors_Value3999_g69595 * Global_Colors_Mask4022_g69595 ));
				float3 lerpResult4086_g69595 = lerp( Blend_Albedo4137_g69595 , lerpResult4007_g69595 , Main_Mask_Leaves3712_g69595);
				half3 Blend_AlbedoColored3711_g69595 = lerpResult4086_g69595;
				float3 temp_output_3681_0_g69595 = (_SubsurfaceColor).rgb;
				float dotResult4019_g69595 = dot( temp_output_3681_0_g69595 , float3(0.2126,0.7152,0.0722) );
				float3 temp_cast_6 = (dotResult4019_g69595).xxx;
				float3 lerpResult4018_g69595 = lerp( temp_output_3681_0_g69595 , temp_cast_6 , Global_Colors_Influence3998_g69595);
				float3 lerpResult4017_g69595 = lerp( temp_output_3681_0_g69595 , ( lerpResult4018_g69595 * Global_Colors3856_g69595 ) , ( Global_Colors_Value3999_g69595 * Global_Colors_Mask4022_g69595 ));
				half3 Subsurface_Color3656_g69595 = lerpResult4017_g69595;
				half Global_Subsurface4111_g69595 = TVE_SubsurfaceValue;
				half Subsurface_Intensity3684_g69595 = ( _SubsurfaceValue * Global_Subsurface4111_g69595 );
				float temp_output_7_0_g69613 = _SubsurfaceMaskMinValue;
				half Subsurface_Mask3666_g69595 = ( saturate( ( ( Main_Height_Or_Blend3609_g69595 - temp_output_7_0_g69613 ) / ( _SubsurfaceMaskMaxValue - temp_output_7_0_g69613 ) ) ) * Main_Mask_Leaves3712_g69595 );
				half3 Subsurface_Transmission3659_g69595 = ( Subsurface_Color3656_g69595 * Subsurface_Intensity3684_g69595 * Subsurface_Mask3666_g69595 );
				half3 MainLight_Direction4110_g69595 = TVE_MainLightDirection;
				float3 ase_worldPos = GetAbsolutePositionWS( packedInput.interp00 );
				float3 ase_worldViewDir = ( _WorldSpaceCameraPos.xyz - ase_worldPos );
				ase_worldViewDir = normalize(ase_worldViewDir);
				float3 normalizeResult3635_g69595 = normalize( ase_worldViewDir );
				float dotResult3631_g69595 = dot( -MainLight_Direction4110_g69595 , normalizeResult3635_g69595 );
				float saferPower3620_g69595 = abs( saturate( dotResult3631_g69595 ) );
				#ifdef UNITY_PASS_FORWARDADD
				float staticSwitch3636_g69595 = 0.0;
				#else
				float staticSwitch3636_g69595 = ( pow( saferPower3620_g69595 , _SubsurfaceAngleValue ) * _SubsurfaceScatteringValue );
				#endif
				half Mask_Subsurface_View3614_g69595 = staticSwitch3636_g69595;
				half3 Subsurface_Approximation3702_g69595 = ( Subsurface_Transmission3659_g69595 * Blend_AlbedoColored3711_g69595 * Mask_Subsurface_View3614_g69595 );
				half3 Albedo_Subsurface3874_g69595 = ( Blend_AlbedoColored3711_g69595 + Subsurface_Approximation3702_g69595 );
				half3 Global_OverlayColor1758_g69595 = (TVE_OverlayColor).rgb;
				half3 World_Normal3638_g69595 = o.Normal;
				float lerpResult4521_g69595 = lerp( Main_Height_Or_Blend3609_g69595 , World_Normal3638_g69595.y , Vegetation_Type4515_g69595);
				half Main_AlbedoTex_G3807_g69595 = Main_Albedo_Raw4295_g69595.y;
				float4 temp_output_93_19_g69596 = TVE_ExtrasCoords;
				float3 lerpResult4483_g69595 = lerp( WorldPosition4027_g69595 , ObjectPosition4422_g69595 , _ExtrasPositionMode);
				half2 UV96_g69596 = ( (temp_output_93_19_g69596).zw + ( (temp_output_93_19_g69596).xy * (lerpResult4483_g69595).xz ) );
				float temp_output_84_0_g69596 = _LayerExtrasValue;
				float4 lerpResult109_g69596 = lerp( TVE_ExtrasParams , SAMPLE_TEXTURE2D_ARRAY_LOD( TVE_ExtrasTex, sampler_linear_repeat, UV96_g69596,temp_output_84_0_g69596, 0.0 ) , TVE_ExtrasUsage[(int)temp_output_84_0_g69596]);
				float4 break89_g69596 = lerpResult109_g69596;
				half Global_ExtrasTex_Overlay156_g69595 = break89_g69596.b;
				float temp_output_3774_0_g69595 = ( _GlobalOverlay * Global_ExtrasTex_Overlay156_g69595 );
				float lerpResult3746_g69595 = lerp( 1.0 , Global_MeshVariation4531_g69595 , _OverlayVariationValue);
				half Overlay_Commons3739_g69595 = ( temp_output_3774_0_g69595 * lerpResult3746_g69595 );
				float temp_output_7_0_g69627 = _OverlayMaskMinValue;
				half Overlay_Mask3762_g69595 = saturate( ( ( ( ( ( lerpResult4521_g69595 * 0.5 ) + Main_AlbedoTex_G3807_g69595 ) * Overlay_Commons3739_g69595 ) - temp_output_7_0_g69627 ) / ( _OverlayMaskMaxValue - temp_output_7_0_g69627 ) ) );
				float3 lerpResult3875_g69595 = lerp( Albedo_Subsurface3874_g69595 , Global_OverlayColor1758_g69595 , Overlay_Mask3762_g69595);
				half3 Final_Albedo4100_g69595 = lerpResult3875_g69595;
				half IsInitialized3811_g69595 = _IsInitialized;
				float3 lerpResult3815_g69595 = lerp( float3( 1,0,0 ) , Final_Albedo4100_g69595 , IsInitialized3811_g69595);
				
				float3 hdEmission4376_g69595 = ASEGetEmissionHDRColor(_EmissiveColor.rgb,_EmissiveIntensityParams.x,_EmissiveExposureValue,GetInverseCurrentExposureMultiplier());
				half Global_ExtrasTex_Emissive4408_g69595 = break89_g69596.r;
				float lerpResult4417_g69595 = lerp( 1.0 , Global_ExtrasTex_Emissive4408_g69595 , _GlobalEmissive);
				half3 Final_Emissive4365_g69595 = ( (( hdEmission4376_g69595 * output1 )).rgb * lerpResult4417_g69595 );
				
				half Main_Mask_Smoothness3820_g69595 = break3589_g69595.a;
				half Main_Smoothness3838_g69595 = ( Main_Mask_Smoothness3820_g69595 * _ImpostorSmoothnessValue );
				half Global_ExtrasTex_Wetness305_g69595 = break89_g69596.g;
				float lerpResult3892_g69595 = lerp( Main_Smoothness3838_g69595 , saturate( ( Main_Smoothness3838_g69595 + Global_ExtrasTex_Wetness305_g69595 ) ) , _GlobalWetness);
				half Final_Smoothness3898_g69595 = lerpResult3892_g69595;
				
				float temp_output_3577_0_g69595 = o.Alpha;
				float localCustomAlphaClipAlways4430_g69595 = ( temp_output_3577_0_g69595 );
				half Global_ExtrasTex_Alpha1033_g69595 = saturate( break89_g69596.a );
				float lerpResult4544_g69595 = lerp( 0.0 , Global_MeshVariation4531_g69595 , _AlphaVariationValue);
				half Global_Alpha_Variation4546_g69595 = lerpResult4544_g69595;
				float lerpResult4053_g69595 = lerp( 1.0 , ( ( Global_ExtrasTex_Alpha1033_g69595 - Global_Alpha_Variation4546_g69595 ) + 0.09 ) , _GlobalAlpha);
				float lerpResult4075_g69595 = lerp( 1.0 , lerpResult4053_g69595 , Main_Mask_Leaves3712_g69595);
				half Final_Alpha4102_g69595 = lerpResult4075_g69595;
				float Alpha4430_g69595 = Final_Alpha4102_g69595;
				{
				clip(Alpha4430_g69595 - 0.1);
				}
				float temp_output_3_0_g69639 = localCustomAlphaClipAlways4430_g69595;
				half Offest27_g69639 = 0.0;
				half Feather30_g69639 = 0.2;
				
				half Subsurface_HD3650_g69595 = ( 1.0 - ( Subsurface_Intensity3684_g69595 * Subsurface_Mask3666_g69595 ) );
				

                surfaceDescription.Albedo = lerpResult3815_g69595;
                o.Normal = World_Normal3638_g69595;
				...
				surfaceDescription.Emission = Final_Emissive4365_g69595;
                surfaceDescription.Smoothness = Final_Smoothness3898_g69595;
                surfaceDescription.Occlusion = 1;
				surfaceDescription.Alpha = ( ( ( temp_output_3_0_g69639 - Offest27_g69639 ) / ( max( fwidth( temp_output_3_0_g69639 ) , 0.001 ) + Feather30_g69639 ) ) + Offest27_g69639 );
				...
				#if defined(_HAS_REFRACTION) || defined(_MATERIAL_FEATURE_TRANSMISSION)
				surfaceDescription.Thickness = Subsurface_HD3650_g69595;
				#endif
		...
		Pass
        {
			...
			PackedVaryingsMeshToPS Vert(AttributesMesh inputMesh  )
			{
				...
				outputPackedVaryingsMeshToPS.ase_texcoord5.xyz = vertexToFrag4543_g69595;
			...
			)
			{
				...
				float3 temp_output_3563_0_g69595 = worldPos;
				float3 WorldPosition4027_g69595 = temp_output_3563_0_g69595;
				float3 vertexToFrag4543_g69595 = packedInput.ase_texcoord5.xyz;
				float3 ObjectPosition4422_g69595 = vertexToFrag4543_g69595;
				float3 lerpResult4483_g69595 = lerp( WorldPosition4027_g69595 , ObjectPosition4422_g69595 , _ExtrasPositionMode);
				half2 UV96_g69596 = ( (temp_output_93_19_g69596).zw + ( (temp_output_93_19_g69596).xy * (lerpResult4483_g69595).xz ) );
				float temp_output_84_0_g69596 = _LayerExtrasValue;
        ...
        Pass
        {
			...
			PackedVaryingsMeshToPS Vert(AttributesMesh inputMesh )
			{
				...
				outputPackedVaryingsMeshToPS.ase_texcoord13.xyz = vertexToFrag4543_g69595;
			...
			)
			{
				...
				float3 temp_output_3563_0_g69595 = worldPos;
				float3 WorldPosition4027_g69595 = temp_output_3563_0_g69595;
				float3 vertexToFrag4543_g69595 = packedInput.ase_texcoord13.xyz;
				float3 ObjectPosition4422_g69595 = vertexToFrag4543_g69595;
				float3 lerpResult4483_g69595 = lerp( WorldPosition4027_g69595 , ObjectPosition4422_g69595 , _ExtrasPositionMode);
				half2 UV96_g69596 = ( (temp_output_93_19_g69596).zw + ( (temp_output_93_19_g69596).xy * (lerpResult4483_g69595).xz ) );
				float temp_output_84_0_g69596 = _LayerExtrasValue;
		...
		Pass
        {
			...
			PackedVaryingsMeshToPS Vert(AttributesMesh inputMesh )
			{
				...
				outputPackedVaryingsMeshToPS.ase_texcoord11.xyz = vertexToFrag4543_g69595;
			...
			)
			{
				...
				float3 temp_output_3563_0_g69595 = worldPos;
				float3 WorldPosition4027_g69595 = temp_output_3563_0_g69595;
				float3 vertexToFrag4543_g69595 = packedInput.ase_texcoord11.xyz;
				float3 ObjectPosition4422_g69595 = vertexToFrag4543_g69595;
				float3 lerpResult4478_g69595 = lerp( WorldPosition4027_g69595 , ObjectPosition4422_g69595 , _ColorsPositionMode);
				half2 UV94_g69614 = ( (temp_output_91_19_g69614).zw + ( (temp_output_91_19_g69614).xy * (lerpResult4478_g69595).xz ) );
				float temp_output_82_0_g69614 = _LayerColorsValue;
...
/*ASEBEGIN
Version=18934
1920;0;1920;1029;2190.966;1035.359;1;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;339;-1152,-768;Half;False;Property;_IsSubsurfaceShader;_IsSubsurfaceShader;142;1;[HideInInspector];Create;True;0;0;0;True;0;False;1;1;1;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;319;-1664,512;Inherit;False;Is ShaderType;-1;;69647;90bdd02d483309144a404aee7f41383d;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;335;-576,-768;Inherit;False;Compile All Shaders;-1;;69646;e67c8238031dbf04ab79a5d4d63d1b4f;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;336;-768,-768;Inherit;False;Compile Impostors;-1;;69645;1cfd52e266bd86c47a094d0358cb5b93;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;338;-1408,512;Inherit;False;Define Pipeline HD AI;-1;;69644;4bfc56eb4c68eb8429d853b857b9fcbe;0;0;1;FLOAT;529
Node;AmplifyShaderEditor.FunctionNode;312;-1024,-256;Inherit;False;Base Impostor;22;;69595;47a437226c28ea34bad309b04e5582cd;31,4299,0,4398,1,4399,1,4400,1,4405,1,4404,1,4406,1,4412,1,4410,1,4447,1,4020,1,4010,1,3868,1,4338,1,4434,1,4539,1,4336,1,3881,1,3891,1,4416,1,1745,1,3479,0,3707,1,3952,1,4496,0,4186,0,1742,0,3484,0,860,1,2260,1,2261,1;7;3592;COLOR;0,0,0,0;False;4370;COLOR;0,0,0,0;False;3583;FLOAT3;0,0,0;False;3574;FLOAT3;0,0,0;False;3577;FLOAT;0;False;3563;FLOAT3;0,0,0;False;3964;FLOAT3;0,0,0;False;15;FLOAT3;3597;FLOAT3;3594;FLOAT3;4372;FLOAT;4373;FLOAT;3595;FLOAT;4119;FLOAT;3598;FLOAT;3980;FLOAT3;3974;FLOAT;3973;FLOAT;3975;FLOAT;4334;FLOAT;3593;FLOAT;4335;FLOAT3;534
...
WireConnection;327;21;312;3975
WireConnection;327;11;312;534
ASEEND*/
//CHKSM=E3FAC7FFE3ED65C0C6B0ECAC209837FB21B184DF
